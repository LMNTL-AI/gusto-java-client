...
import com.gusto.embedded_api_v_2026_06_15.models.components.DocumentSigned;
...
import com.gusto.embedded_api_v_2026_06_15.models.operations.PutV1ContractorDocumentSignRequest;
import com.gusto.embedded_api_v_2026_06_15.models.operations.PutV1ContractorDocumentSignResponse;
...
public class PutV1ContractorDocumentSign {
    ...
    public static class Sync extends Base
            implements RequestOperation<PutV1ContractorDocumentSignRequest, PutV1ContractorDocumentSignResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PutV1ContractorDocumentSignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutV1ContractorDocumentSignRequest.class, new TypeReference<PutV1ContractorDocumentSignRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutV1ContractorDocumentSignRequest request) {
        ...
        @Override
        public PutV1ContractorDocumentSignResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PutV1ContractorDocumentSignResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1ContractorDocumentSignRequest, com.gusto.embedded_api_v_2026_06_15.models.operations.async.PutV1ContractorDocumentSignResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PutV1ContractorDocumentSignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutV1ContractorDocumentSignRequest.class, new TypeReference<PutV1ContractorDocumentSignRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PutV1ContractorDocumentSignRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2026_06_15.models.operations.async.PutV1ContractorDocumentSignResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2026_06_15.models.operations.async.PutV1ContractorDocumentSignResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2026_06_15.models.operations.async.PutV1ContractorDocumentSignResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
