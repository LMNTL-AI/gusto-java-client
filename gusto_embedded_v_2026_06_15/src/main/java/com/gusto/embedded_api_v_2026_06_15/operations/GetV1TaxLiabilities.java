...
import com.gusto.embedded_api_v_2026_06_15.models.operations.GetV1TaxLiabilitiesRequest;
import com.gusto.embedded_api_v_2026_06_15.models.operations.GetV1TaxLiabilitiesResponse;
...
public class GetV1TaxLiabilities {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetV1TaxLiabilitiesRequest, GetV1TaxLiabilitiesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetV1TaxLiabilitiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetV1TaxLiabilitiesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1TaxLiabilitiesRequest request) {
        ...
        @Override
        public GetV1TaxLiabilitiesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetV1TaxLiabilitiesResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1TaxLiabilitiesRequest, com.gusto.embedded_api_v_2026_06_15.models.operations.async.GetV1TaxLiabilitiesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetV1TaxLiabilitiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetV1TaxLiabilitiesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetV1TaxLiabilitiesRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2026_06_15.models.operations.async.GetV1TaxLiabilitiesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2026_06_15.models.operations.async.GetV1TaxLiabilitiesResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2026_06_15.models.operations.async.GetV1TaxLiabilitiesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
