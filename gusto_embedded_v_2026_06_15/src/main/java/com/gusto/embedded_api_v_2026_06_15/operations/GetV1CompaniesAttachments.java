...
import com.gusto.embedded_api_v_2026_06_15.models.operations.GetV1CompaniesAttachmentsRequest;
import com.gusto.embedded_api_v_2026_06_15.models.operations.GetV1CompaniesAttachmentsResponse;
...
public class GetV1CompaniesAttachments {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetV1CompaniesAttachmentsRequest, GetV1CompaniesAttachmentsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetV1CompaniesAttachmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetV1CompaniesAttachmentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesAttachmentsRequest request) {
        ...
        @Override
        public GetV1CompaniesAttachmentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetV1CompaniesAttachmentsResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesAttachmentsRequest, com.gusto.embedded_api_v_2026_06_15.models.operations.async.GetV1CompaniesAttachmentsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetV1CompaniesAttachmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetV1CompaniesAttachmentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetV1CompaniesAttachmentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2026_06_15.models.operations.async.GetV1CompaniesAttachmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2026_06_15.models.operations.async.GetV1CompaniesAttachmentsResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2026_06_15.models.operations.async.GetV1CompaniesAttachmentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
