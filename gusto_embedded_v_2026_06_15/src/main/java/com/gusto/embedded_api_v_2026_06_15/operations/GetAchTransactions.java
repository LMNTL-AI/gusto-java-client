...
import com.gusto.embedded_api_v_2026_06_15.models.components.AchTransaction;
...
public class GetAchTransactions {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAchTransactionsRequest, GetAchTransactionsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAchTransactionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAchTransactionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAchTransactionsRequest request) {
        ...
        @Override
        public GetAchTransactionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAchTransactionsResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAchTransactionsRequest, com.gusto.embedded_api_v_2026_06_15.models.operations.async.GetAchTransactionsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAchTransactionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAchTransactionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAchTransactionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2026_06_15.models.operations.async.GetAchTransactionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2026_06_15.models.operations.async.GetAchTransactionsResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2026_06_15.models.operations.async.GetAchTransactionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2026_06_15.models.operations.async.GetAchTransactionsResponse res = resBuilder.build();
