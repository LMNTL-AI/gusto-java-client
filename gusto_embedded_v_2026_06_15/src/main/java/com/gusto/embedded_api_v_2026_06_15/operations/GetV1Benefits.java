...
import com.gusto.embedded_api_v_2026_06_15.models.operations.GetV1BenefitsRequest;
import com.gusto.embedded_api_v_2026_06_15.models.operations.GetV1BenefitsResponse;
...
public class GetV1Benefits {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetV1BenefitsRequest, GetV1BenefitsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetV1BenefitsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1BenefitsRequest request) {
        ...
        @Override
        public GetV1BenefitsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetV1BenefitsResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1BenefitsRequest, com.gusto.embedded_api_v_2026_06_15.models.operations.async.GetV1BenefitsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetV1BenefitsRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetV1BenefitsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2026_06_15.models.operations.async.GetV1BenefitsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2026_06_15.models.operations.async.GetV1BenefitsResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2026_06_15.models.operations.async.GetV1BenefitsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
