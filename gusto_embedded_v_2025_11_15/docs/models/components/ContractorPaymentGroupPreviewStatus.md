...
```java
import com.gusto.embedded_api.models.components.ContractorPaymentGroupPreviewStatus;

ContractorPaymentGroupPreviewStatus value = ContractorPaymentGroupPreviewStatus.UNFUNDED;
```
