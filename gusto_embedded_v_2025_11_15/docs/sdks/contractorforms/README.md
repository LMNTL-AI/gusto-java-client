...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, Exception {
        ...
        GetV1ContractorFormsResponse res = sdk.contractorForms().list()
                .xGustoAPIVersion(GetV1ContractorFormsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS11_MINUS15)
                .contractorUuid("<id>")
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, Exception {
        ...
        GetV1ContractorFormResponse res = sdk.contractorForms().get()
                .xGustoAPIVersion(GetV1ContractorFormHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS11_MINUS15)
                .contractorUuid("<id>")
                .formId("<id>")
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, Exception {
        ...
        GetV1ContractorFormPdfResponse res = sdk.contractorForms().getPdf()
                .xGustoAPIVersion(GetV1ContractorFormPdfHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS11_MINUS15)
                .contractorUuid("<id>")
                .formId("<id>")
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, UnprocessableEntityError, Exception {
        ...
        PostV1SandboxGenerate1099Response res = sdk.contractorForms().generate1099()
                .xGustoAPIVersion(PostV1SandboxGenerate1099HeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS11_MINUS15)
