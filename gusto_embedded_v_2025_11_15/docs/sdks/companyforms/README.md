...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, Exception {
        ...
        GetV1CompanyFormResponse res = sdk.companyForms().get()
                .xGustoAPIVersion(GetV1CompanyFormHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS11_MINUS15)
                .formId("<id>")
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, Exception {
        ...
        GetV1CompanyFormPdfResponse res = sdk.companyForms().getPdf()
                .xGustoAPIVersion(GetV1CompanyFormPdfHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS11_MINUS15)
                .formId("<id>")
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, UnprocessableEntityError, Exception {
        ...
        PutV1CompanyFormSignResponse res = sdk.companyForms().sign()
                .xGustoAPIVersion(PutV1CompanyFormSignHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS11_MINUS15)
                .formId("<id>")
