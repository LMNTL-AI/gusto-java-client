...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, Exception {
        ...
        GetV1CompaniesCompanyIdFederalTaxDetailsResponse res = sdk.federalTaxDetails().get()
                ...
                .xGustoAPIVersion(GetV1CompaniesCompanyIdFederalTaxDetailsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS11_MINUS15)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, UnprocessableEntityError, Exception {
        ...
        PutV1CompaniesCompanyIdFederalTaxDetailsResponse res = sdk.federalTaxDetails().update()
                .companyId("7b1d0df1-6403-4a06-8768-c1dd7d24d27a")
                .xGustoAPIVersion(PutV1CompaniesCompanyIdFederalTaxDetailsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS11_MINUS15)
