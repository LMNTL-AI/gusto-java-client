...
public class PaymentConfigs {
     ...
     * @throws RuntimeException subclass if the API call fails
     */
    public GetV1CompanyPaymentConfigsResponse get(Optional<? extends GetV1CompanyPaymentConfigsHeaderXGustoAPIVersion> xGustoAPIVersion, String companyUuid) {
     ...
     * @throws RuntimeException subclass if the API call fails
     */
    public PutV1CompanyPaymentConfigsResponse update(String companyUuid, PaymentConfigsUpdateRequest paymentConfigsUpdateRequest) {
