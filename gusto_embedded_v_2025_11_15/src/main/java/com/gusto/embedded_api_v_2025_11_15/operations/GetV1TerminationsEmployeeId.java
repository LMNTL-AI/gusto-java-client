...
public class GetV1TerminationsEmployeeId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1TerminationsEmployeeIdRequest, com.gusto.embedded_api.models.operations.async.GetV1TerminationsEmployeeIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1TerminationsEmployeeIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1TerminationsEmployeeIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1TerminationsEmployeeIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1TerminationsEmployeeIdResponse res = resBuilder.build();
