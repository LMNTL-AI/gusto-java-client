...
public class GetV1EmployeesEmployeeIdPaymentMethod {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1EmployeesEmployeeIdPaymentMethodRequest, com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdPaymentMethodResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdPaymentMethodResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdPaymentMethodResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdPaymentMethodResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdPaymentMethodResponse res = resBuilder.build();
