...
public class PutV1LocationsLocationId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1LocationsLocationIdRequest, com.gusto.embedded_api.models.operations.async.PutV1LocationsLocationIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1LocationsLocationIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1LocationsLocationIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1LocationsLocationIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
