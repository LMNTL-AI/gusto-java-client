...
public class PostV1ExternalPayroll {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1ExternalPayrollRequest, com.gusto.embedded_api.models.operations.async.PostV1ExternalPayrollResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1ExternalPayrollResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1ExternalPayrollResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1ExternalPayrollResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1ExternalPayrollResponse res = resBuilder.build();
