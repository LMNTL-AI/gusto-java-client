...
public class PutV1TaxLiabilities {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1TaxLiabilitiesRequest, com.gusto.embedded_api.models.operations.async.PutV1TaxLiabilitiesResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1TaxLiabilitiesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1TaxLiabilitiesResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1TaxLiabilitiesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
