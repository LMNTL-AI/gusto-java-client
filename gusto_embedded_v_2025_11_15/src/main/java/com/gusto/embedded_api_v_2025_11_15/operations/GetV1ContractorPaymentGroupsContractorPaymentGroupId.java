...
public class GetV1ContractorPaymentGroupsContractorPaymentGroupId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ContractorPaymentGroupsContractorPaymentGroupIdRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1ContractorPaymentGroupsContractorPaymentGroupIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1ContractorPaymentGroupsContractorPaymentGroupIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1ContractorPaymentGroupsContractorPaymentGroupIdResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1ContractorPaymentGroupsContractorPaymentGroupIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1ContractorPaymentGroupsContractorPaymentGroupIdResponse res = resBuilder.build();
