...
public class PutV1EmployeeFormSign {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1EmployeeFormSignRequest, com.gusto.embedded_api.models.operations.async.PutV1EmployeeFormSignResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1EmployeeFormSignResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1EmployeeFormSignResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1EmployeeFormSignResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1EmployeeFormSignResponse res = resBuilder.build();
