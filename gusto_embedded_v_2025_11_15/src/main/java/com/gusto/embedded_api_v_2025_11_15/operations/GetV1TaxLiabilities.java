...
public class GetV1TaxLiabilities {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1TaxLiabilitiesRequest, com.gusto.embedded_api.models.operations.async.GetV1TaxLiabilitiesResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1TaxLiabilitiesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1TaxLiabilitiesResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1TaxLiabilitiesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1TaxLiabilitiesResponse res = resBuilder.build();
