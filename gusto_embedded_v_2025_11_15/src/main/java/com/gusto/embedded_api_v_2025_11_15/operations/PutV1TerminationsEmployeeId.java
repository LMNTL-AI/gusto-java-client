...
public class PutV1TerminationsEmployeeId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1TerminationsEmployeeIdRequest, com.gusto.embedded_api.models.operations.async.PutV1TerminationsEmployeeIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1TerminationsEmployeeIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1TerminationsEmployeeIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1TerminationsEmployeeIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
