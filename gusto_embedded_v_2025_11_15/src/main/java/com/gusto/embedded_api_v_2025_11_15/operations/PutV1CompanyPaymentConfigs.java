...
import com.gusto.embedded_api.models.components.PaymentConfigs;
...
public class PutV1CompanyPaymentConfigs {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompanyPaymentConfigsRequest, com.gusto.embedded_api.models.operations.async.PutV1CompanyPaymentConfigsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1CompanyPaymentConfigsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1CompanyPaymentConfigsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1CompanyPaymentConfigsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1CompanyPaymentConfigsResponse res = resBuilder.build();
