...
public class GetV1ContractorsContractorUuidPaymentMethod {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ContractorsContractorUuidPaymentMethodRequest, com.gusto.embedded_api.models.operations.async.GetV1ContractorsContractorUuidPaymentMethodResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1ContractorsContractorUuidPaymentMethodResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1ContractorsContractorUuidPaymentMethodResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1ContractorsContractorUuidPaymentMethodResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1ContractorsContractorUuidPaymentMethodResponse res = resBuilder.build();
