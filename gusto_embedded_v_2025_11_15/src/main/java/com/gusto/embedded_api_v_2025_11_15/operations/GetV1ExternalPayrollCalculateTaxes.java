...
public class GetV1ExternalPayrollCalculateTaxes {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ExternalPayrollCalculateTaxesRequest, com.gusto.embedded_api.models.operations.async.GetV1ExternalPayrollCalculateTaxesResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1ExternalPayrollCalculateTaxesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1ExternalPayrollCalculateTaxesResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1ExternalPayrollCalculateTaxesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1ExternalPayrollCalculateTaxesResponse res = resBuilder.build();
