...
public class GetV1Benefits {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1BenefitsRequest, com.gusto.embedded_api.models.operations.async.GetV1BenefitsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1BenefitsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1BenefitsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1BenefitsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1BenefitsResponse res = resBuilder.build();
