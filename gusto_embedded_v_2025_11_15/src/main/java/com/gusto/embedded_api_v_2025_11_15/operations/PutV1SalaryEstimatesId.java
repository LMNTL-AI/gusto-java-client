...
public class PutV1SalaryEstimatesId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1SalaryEstimatesIdRequest, com.gusto.embedded_api.models.operations.async.PutV1SalaryEstimatesIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1SalaryEstimatesIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1SalaryEstimatesIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1SalaryEstimatesIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1SalaryEstimatesIdResponse res = resBuilder.build();
