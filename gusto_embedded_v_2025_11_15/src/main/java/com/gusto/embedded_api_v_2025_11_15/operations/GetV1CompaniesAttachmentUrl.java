...
public class GetV1CompaniesAttachmentUrl {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesAttachmentUrlRequest, com.gusto.embedded_api.models.operations.async.GetV1CompaniesAttachmentUrlResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompaniesAttachmentUrlResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompaniesAttachmentUrlResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompaniesAttachmentUrlResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompaniesAttachmentUrlResponse res = resBuilder.build();
