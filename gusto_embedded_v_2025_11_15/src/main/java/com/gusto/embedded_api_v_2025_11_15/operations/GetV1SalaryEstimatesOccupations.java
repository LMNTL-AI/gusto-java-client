...
import com.gusto.embedded_api.models.components.BLSOccupation;
...
public class GetV1SalaryEstimatesOccupations {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1SalaryEstimatesOccupationsRequest, com.gusto.embedded_api.models.operations.async.GetV1SalaryEstimatesOccupationsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1SalaryEstimatesOccupationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1SalaryEstimatesOccupationsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1SalaryEstimatesOccupationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1SalaryEstimatesOccupationsResponse res = resBuilder.build();
