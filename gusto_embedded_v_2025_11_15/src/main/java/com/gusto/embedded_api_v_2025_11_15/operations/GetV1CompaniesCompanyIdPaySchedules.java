...
public class GetV1CompaniesCompanyIdPaySchedules {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyIdPaySchedulesRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesResponse res = resBuilder.build();
