...
public class PutV1CompanyFormSign {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompanyFormSignRequest, com.gusto.embedded_api.models.operations.async.PutV1CompanyFormSignResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1CompanyFormSignResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1CompanyFormSignResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1CompanyFormSignResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1CompanyFormSignResponse res = resBuilder.build();
