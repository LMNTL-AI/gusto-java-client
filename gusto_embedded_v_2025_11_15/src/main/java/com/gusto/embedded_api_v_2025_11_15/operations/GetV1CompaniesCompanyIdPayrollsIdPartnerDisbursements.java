...
import com.gusto.embedded_api.models.components.PayrollPartnerDisbursements;
...
public class GetV1CompaniesCompanyIdPayrollsIdPartnerDisbursements {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsRequest, com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsResponse res = resBuilder.build();
