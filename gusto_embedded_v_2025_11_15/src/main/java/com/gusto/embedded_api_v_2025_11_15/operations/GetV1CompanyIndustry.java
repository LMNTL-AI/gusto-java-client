...
public class GetV1CompanyIndustry {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompanyIndustryRequest, com.gusto.embedded_api.models.operations.async.GetV1CompanyIndustryResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompanyIndustryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompanyIndustryResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompanyIndustryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompanyIndustryResponse res = resBuilder.build();
