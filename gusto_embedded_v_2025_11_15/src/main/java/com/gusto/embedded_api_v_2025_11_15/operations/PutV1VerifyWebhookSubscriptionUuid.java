...
public class PutV1VerifyWebhookSubscriptionUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1VerifyWebhookSubscriptionUuidRequest, com.gusto.embedded_api.models.operations.async.PutV1VerifyWebhookSubscriptionUuidResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1VerifyWebhookSubscriptionUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1VerifyWebhookSubscriptionUuidResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1VerifyWebhookSubscriptionUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1VerifyWebhookSubscriptionUuidResponse res = resBuilder.build();
