...
public class GetV1CompanyFormPdf {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompanyFormPdfRequest, com.gusto.embedded_api.models.operations.async.GetV1CompanyFormPdfResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompanyFormPdfResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompanyFormPdfResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompanyFormPdfResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompanyFormPdfResponse res = resBuilder.build();
