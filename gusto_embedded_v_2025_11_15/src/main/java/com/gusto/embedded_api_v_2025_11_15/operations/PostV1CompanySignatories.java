...
public class PostV1CompanySignatories {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompanySignatoriesRequest, com.gusto.embedded_api.models.operations.async.PostV1CompanySignatoriesResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1CompanySignatoriesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1CompanySignatoriesResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1CompanySignatoriesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1CompanySignatoriesResponse res = resBuilder.build();
