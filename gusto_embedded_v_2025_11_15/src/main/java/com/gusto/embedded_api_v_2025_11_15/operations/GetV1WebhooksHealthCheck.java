...
public class GetV1WebhooksHealthCheck {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1WebhooksHealthCheckRequest, com.gusto.embedded_api.models.operations.async.GetV1WebhooksHealthCheckResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1WebhooksHealthCheckResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1WebhooksHealthCheckResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1WebhooksHealthCheckResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
