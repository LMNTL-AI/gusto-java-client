...
public class GetV1RecurringReimbursements {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1RecurringReimbursementsRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1RecurringReimbursementsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1RecurringReimbursementsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1RecurringReimbursementsResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1RecurringReimbursementsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1RecurringReimbursementsResponse res = resBuilder.build();
