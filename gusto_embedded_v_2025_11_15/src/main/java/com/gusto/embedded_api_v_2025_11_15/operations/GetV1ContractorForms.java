...
public class GetV1ContractorForms {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ContractorFormsRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1ContractorFormsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1ContractorFormsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1ContractorFormsResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1ContractorFormsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1ContractorFormsResponse res = resBuilder.build();
