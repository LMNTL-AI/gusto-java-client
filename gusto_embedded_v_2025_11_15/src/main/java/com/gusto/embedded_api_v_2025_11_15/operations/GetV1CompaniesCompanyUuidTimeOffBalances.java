...
public class GetV1CompaniesCompanyUuidTimeOffBalances {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyUuidTimeOffBalancesRequest, com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyUuidTimeOffBalancesResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyUuidTimeOffBalancesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyUuidTimeOffBalancesResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyUuidTimeOffBalancesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
