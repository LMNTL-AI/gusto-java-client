...
public class PutAddPeopleToDepartment {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutAddPeopleToDepartmentRequest, com.gusto.embedded_api.models.operations.async.PutAddPeopleToDepartmentResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutAddPeopleToDepartmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutAddPeopleToDepartmentResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutAddPeopleToDepartmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutAddPeopleToDepartmentResponse res = resBuilder.build();
