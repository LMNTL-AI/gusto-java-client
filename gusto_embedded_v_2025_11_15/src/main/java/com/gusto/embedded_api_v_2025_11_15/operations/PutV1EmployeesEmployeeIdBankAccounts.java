...
public class PutV1EmployeesEmployeeIdBankAccounts {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1EmployeesEmployeeIdBankAccountsRequest, com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdBankAccountsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdBankAccountsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdBankAccountsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdBankAccountsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdBankAccountsResponse res = resBuilder.build();
