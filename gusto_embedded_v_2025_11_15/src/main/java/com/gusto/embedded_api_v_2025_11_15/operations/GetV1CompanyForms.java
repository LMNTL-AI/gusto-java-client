...
public class GetV1CompanyForms {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompanyFormsRequest, com.gusto.embedded_api.models.operations.async.GetV1CompanyFormsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompanyFormsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompanyFormsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompanyFormsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompanyFormsResponse res = resBuilder.build();
