...
public class GetV1BenefitsCompanyBenefitIdSummary {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1BenefitsCompanyBenefitIdSummaryRequest, com.gusto.embedded_api.models.operations.async.GetV1BenefitsCompanyBenefitIdSummaryResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1BenefitsCompanyBenefitIdSummaryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1BenefitsCompanyBenefitIdSummaryResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1BenefitsCompanyBenefitIdSummaryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1BenefitsCompanyBenefitIdSummaryResponse res = resBuilder.build();
