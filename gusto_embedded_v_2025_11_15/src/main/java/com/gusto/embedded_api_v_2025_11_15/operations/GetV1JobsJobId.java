...
public class GetV1JobsJobId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1JobsJobIdRequest, com.gusto.embedded_api.models.operations.async.GetV1JobsJobIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1JobsJobIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1JobsJobIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1JobsJobIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1JobsJobIdResponse res = resBuilder.build();
