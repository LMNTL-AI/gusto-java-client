...
public class GetV1EmployeeBenefitsEmployeeBenefitId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1EmployeeBenefitsEmployeeBenefitIdRequest, com.gusto.embedded_api.models.operations.async.GetV1EmployeeBenefitsEmployeeBenefitIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1EmployeeBenefitsEmployeeBenefitIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1EmployeeBenefitsEmployeeBenefitIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1EmployeeBenefitsEmployeeBenefitIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1EmployeeBenefitsEmployeeBenefitIdResponse res = resBuilder.build();
