...
public class GetV1GarnishmentsGarnishmentId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1GarnishmentsGarnishmentIdRequest, com.gusto.embedded_api.models.operations.async.GetV1GarnishmentsGarnishmentIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1GarnishmentsGarnishmentIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1GarnishmentsGarnishmentIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1GarnishmentsGarnishmentIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1GarnishmentsGarnishmentIdResponse res = resBuilder.build();
