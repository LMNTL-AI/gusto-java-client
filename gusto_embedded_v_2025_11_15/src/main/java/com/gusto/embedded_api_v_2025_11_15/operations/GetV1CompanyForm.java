...
import com.gusto.embedded_api_v_2025_11_15.models.operations.GetV1CompanyFormRequest;
import com.gusto.embedded_api_v_2025_11_15.models.operations.GetV1CompanyFormResponse;
...
public class GetV1CompanyForm {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetV1CompanyFormRequest, GetV1CompanyFormResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetV1CompanyFormRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetV1CompanyFormRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompanyFormRequest request) {
        ...
        @Override
        public GetV1CompanyFormResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetV1CompanyFormResponse.Builder resBuilder =
            ...
            GetV1CompanyFormResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompanyFormRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompanyFormResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetV1CompanyFormRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetV1CompanyFormRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetV1CompanyFormRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompanyFormResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompanyFormResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompanyFormResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompanyFormResponse res = resBuilder.build();
