...
import com.gusto.embedded_api.models.operations.PutV1RecurringReimbursementsResponse;
...
public class PutV1RecurringReimbursements {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1RecurringReimbursementsRequest, com.gusto.embedded_api.models.operations.async.PutV1RecurringReimbursementsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1RecurringReimbursementsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1RecurringReimbursementsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1RecurringReimbursementsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1RecurringReimbursementsResponse res = resBuilder.build();
