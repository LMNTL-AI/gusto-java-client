...
public class GetV1CompanyBenefitsCompanyBenefitIdContributionExclusions {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompanyBenefitsCompanyBenefitIdContributionExclusionsRequest, com.gusto.embedded_api.models.operations.async.GetV1CompanyBenefitsCompanyBenefitIdContributionExclusionsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompanyBenefitsCompanyBenefitIdContributionExclusionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompanyBenefitsCompanyBenefitIdContributionExclusionsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompanyBenefitsCompanyBenefitIdContributionExclusionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompanyBenefitsCompanyBenefitIdContributionExclusionsResponse res = resBuilder.build();
