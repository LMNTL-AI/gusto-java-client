...
public class PutV1GarnishmentsGarnishmentId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1GarnishmentsGarnishmentIdRequest, com.gusto.embedded_api.models.operations.async.PutV1GarnishmentsGarnishmentIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1GarnishmentsGarnishmentIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1GarnishmentsGarnishmentIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1GarnishmentsGarnishmentIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1GarnishmentsGarnishmentIdResponse res = resBuilder.build();
