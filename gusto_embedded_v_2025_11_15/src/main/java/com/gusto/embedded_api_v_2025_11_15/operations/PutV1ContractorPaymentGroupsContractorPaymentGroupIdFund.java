...
public class PutV1ContractorPaymentGroupsContractorPaymentGroupIdFund {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1ContractorPaymentGroupsContractorPaymentGroupIdFundRequest, com.gusto.embedded_api.models.operations.async.PutV1ContractorPaymentGroupsContractorPaymentGroupIdFundResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1ContractorPaymentGroupsContractorPaymentGroupIdFundResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1ContractorPaymentGroupsContractorPaymentGroupIdFundResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1ContractorPaymentGroupsContractorPaymentGroupIdFundResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
