...
public class GetV1GarnishmentsChildSupport {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1GarnishmentsChildSupportRequest, com.gusto.embedded_api.models.operations.async.GetV1GarnishmentsChildSupportResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1GarnishmentsChildSupportResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1GarnishmentsChildSupportResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1GarnishmentsChildSupportResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
