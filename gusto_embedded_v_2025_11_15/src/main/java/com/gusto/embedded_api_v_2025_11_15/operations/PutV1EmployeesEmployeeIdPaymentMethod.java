...
import com.gusto.embedded_api.models.components.EmployeePaymentMethod;
...
public class PutV1EmployeesEmployeeIdPaymentMethod {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1EmployeesEmployeeIdPaymentMethodRequest, com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdPaymentMethodResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdPaymentMethodResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdPaymentMethodResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdPaymentMethodResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdPaymentMethodResponse res = resBuilder.build();
