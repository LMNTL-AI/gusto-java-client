...
public class GetV1TimeOffPoliciesTimeOffPolicyUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1TimeOffPoliciesTimeOffPolicyUuidRequest, com.gusto.embedded_api.models.operations.async.GetV1TimeOffPoliciesTimeOffPolicyUuidResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1TimeOffPoliciesTimeOffPolicyUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1TimeOffPoliciesTimeOffPolicyUuidResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1TimeOffPoliciesTimeOffPolicyUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1TimeOffPoliciesTimeOffPolicyUuidResponse res = resBuilder.build();
