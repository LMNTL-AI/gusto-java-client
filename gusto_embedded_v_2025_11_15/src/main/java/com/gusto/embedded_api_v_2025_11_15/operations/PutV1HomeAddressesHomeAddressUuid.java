...
public class PutV1HomeAddressesHomeAddressUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1HomeAddressesHomeAddressUuidRequest, com.gusto.embedded_api.models.operations.async.PutV1HomeAddressesHomeAddressUuidResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1HomeAddressesHomeAddressUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1HomeAddressesHomeAddressUuidResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1HomeAddressesHomeAddressUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
