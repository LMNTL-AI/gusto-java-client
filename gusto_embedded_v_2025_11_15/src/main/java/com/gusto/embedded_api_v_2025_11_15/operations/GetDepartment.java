...
public class GetDepartment {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDepartmentRequest, com.gusto.embedded_api.models.operations.async.GetDepartmentResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetDepartmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetDepartmentResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetDepartmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetDepartmentResponse res = resBuilder.build();
