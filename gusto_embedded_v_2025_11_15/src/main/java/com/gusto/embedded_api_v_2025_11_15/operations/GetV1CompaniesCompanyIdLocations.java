...
public class GetV1CompaniesCompanyIdLocations {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyIdLocationsRequest, com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdLocationsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdLocationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdLocationsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdLocationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdLocationsResponse res = resBuilder.build();
