...
public class PutV1EmployeesEmployeeIdOnboardingDocumentsConfig {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1EmployeesEmployeeIdOnboardingDocumentsConfigRequest, com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdOnboardingDocumentsConfigResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdOnboardingDocumentsConfigResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdOnboardingDocumentsConfigResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdOnboardingDocumentsConfigResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdOnboardingDocumentsConfigResponse res = resBuilder.build();
