...
public class GetV1CompaniesCompanyIdContractorPaymentContractorPayment {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyIdContractorPaymentContractorPaymentRequest, com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdContractorPaymentContractorPaymentResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdContractorPaymentContractorPaymentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdContractorPaymentContractorPaymentResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdContractorPaymentContractorPaymentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdContractorPaymentContractorPaymentResponse res = resBuilder.build();
