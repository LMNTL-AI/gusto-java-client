...
public class PostV1PartnerManagedCompanies {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1PartnerManagedCompaniesRequest, com.gusto.embedded_api.models.operations.async.PostV1PartnerManagedCompaniesResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1PartnerManagedCompaniesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1PartnerManagedCompaniesResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1PartnerManagedCompaniesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
