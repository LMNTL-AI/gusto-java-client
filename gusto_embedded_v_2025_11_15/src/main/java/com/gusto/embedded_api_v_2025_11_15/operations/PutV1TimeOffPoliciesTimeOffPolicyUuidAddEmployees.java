...
public class PutV1TimeOffPoliciesTimeOffPolicyUuidAddEmployees {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1TimeOffPoliciesTimeOffPolicyUuidAddEmployeesRequest, com.gusto.embedded_api.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidAddEmployeesResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidAddEmployeesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidAddEmployeesResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidAddEmployeesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidAddEmployeesResponse res = resBuilder.build();
