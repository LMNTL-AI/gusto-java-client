...
import com.gusto.embedded_api_v_2025_11_15.models.components.ShowEmployees;
...
public class GetV1CompaniesCompanyIdEmployees {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyIdEmployeesRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompaniesCompanyIdEmployeesResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompaniesCompanyIdEmployeesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompaniesCompanyIdEmployeesResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompaniesCompanyIdEmployeesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompaniesCompanyIdEmployeesResponse res = resBuilder.build();
