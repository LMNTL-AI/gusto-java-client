...
import com.gusto.embedded_api.models.components.ContractorPaymentGroupPreview;
...
public class PostV1CompaniesCompanyIdContractorPaymentGroupsPreview {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompaniesCompanyIdContractorPaymentGroupsPreviewRequest, com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdContractorPaymentGroupsPreviewResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdContractorPaymentGroupsPreviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdContractorPaymentGroupsPreviewResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdContractorPaymentGroupsPreviewResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdContractorPaymentGroupsPreviewResponse res = resBuilder.build();
