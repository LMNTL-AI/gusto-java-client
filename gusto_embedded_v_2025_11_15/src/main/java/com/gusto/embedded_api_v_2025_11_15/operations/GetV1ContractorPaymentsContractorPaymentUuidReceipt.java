...
public class GetV1ContractorPaymentsContractorPaymentUuidReceipt {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ContractorPaymentsContractorPaymentUuidReceiptRequest, com.gusto.embedded_api.models.operations.async.GetV1ContractorPaymentsContractorPaymentUuidReceiptResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1ContractorPaymentsContractorPaymentUuidReceiptResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1ContractorPaymentsContractorPaymentUuidReceiptResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1ContractorPaymentsContractorPaymentUuidReceiptResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1ContractorPaymentsContractorPaymentUuidReceiptResponse res = resBuilder.build();
