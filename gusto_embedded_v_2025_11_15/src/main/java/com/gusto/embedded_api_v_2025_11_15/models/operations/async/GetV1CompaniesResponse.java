...
public class GetV1CompaniesResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public GetV1CompaniesResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetV1CompaniesResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetV1CompaniesResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetV1CompaniesResponse other = (GetV1CompaniesResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetV1CompaniesResponse.class,
    ...
    public final static class Builder {
        ...
        public GetV1CompaniesResponse build() {

            return new GetV1CompaniesResponse(
                contentType, statusCode, rawResponse,
                company);
        }
