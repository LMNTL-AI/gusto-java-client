...
public class LaborDay {
    ...
    public LaborDay withSelected(boolean selected) {
        Utils.checkNotNull(selected, "selected");
    ...
    public LaborDay withSelected(Optional<Boolean> selected) {
        Utils.checkNotNull(selected, "selected");
        this.selected = selected;
        return this;
    }

    public LaborDay withName(String name) {
        Utils.checkNotNull(name, "name");
    ...
    public LaborDay withName(Optional<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public LaborDay withDate(String date) {
        Utils.checkNotNull(date, "date");
    ...
    public LaborDay withDate(Optional<String> date) {
        Utils.checkNotNull(date, "date");
        this.date = date;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(LaborDay.class,
                "selected", selected,
                "name", name,
                "date", date);
    }
