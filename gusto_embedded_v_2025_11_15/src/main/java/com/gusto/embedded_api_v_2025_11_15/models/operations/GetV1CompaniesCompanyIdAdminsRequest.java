...
public class GetV1CompaniesCompanyIdAdminsRequest {
     ...
     * The UUID of the company
     */
    public GetV1CompaniesCompanyIdAdminsRequest withCompanyId(String companyId) {
        Utils.checkNotNull(companyId, "companyId");
        this.companyId = companyId;
        return this;
    }
     ...
     * pagination.
     */
    public GetV1CompaniesCompanyIdAdminsRequest withPage(long page) {
        Utils.checkNotNull(page, "page");
     ...
     * pagination.
     */
    public GetV1CompaniesCompanyIdAdminsRequest withPage(Optional<Long> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * Number of objects per page. For majority of endpoints will default to 25
     */
    public GetV1CompaniesCompanyIdAdminsRequest withPer(long per) {
        Utils.checkNotNull(per, "per");
     ...
     * Number of objects per page. For majority of endpoints will default to 25
     */
    public GetV1CompaniesCompanyIdAdminsRequest withPer(Optional<Long> per) {
        Utils.checkNotNull(per, "per");
        this.per = per;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetV1CompaniesCompanyIdAdminsRequest other = (GetV1CompaniesCompanyIdAdminsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetV1CompaniesCompanyIdAdminsRequest.class,
    ...
    public final static class Builder {
        ...
        public GetV1CompaniesCompanyIdAdminsRequest build() {
            if (xGustoAPIVersion == null) {
                xGustoAPIVersion = _SINGLETON_VALUE_XGustoAPIVersion.value();
            }

            return new GetV1CompaniesCompanyIdAdminsRequest(
                xGustoAPIVersion, companyId, page,
                per);
        }
