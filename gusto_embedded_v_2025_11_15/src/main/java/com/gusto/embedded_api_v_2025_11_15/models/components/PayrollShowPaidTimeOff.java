...
public class PayrollShowPaidTimeOff {
    /**
     ...
     * The name of the PTO. This also serves as the unique, immutable identifier for the PTO.
     */
    public PayrollShowPaidTimeOff withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * The name of the PTO. This also serves as the unique, immutable identifier for the PTO.
     */
    public PayrollShowPaidTimeOff withName(Optional<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The hours of this PTO taken during the pay period.
     */
    public PayrollShowPaidTimeOff withHours(String hours) {
        Utils.checkNotNull(hours, "hours");
     ...
     * The hours of this PTO taken during the pay period.
     */
    public PayrollShowPaidTimeOff withHours(Optional<String> hours) {
        Utils.checkNotNull(hours, "hours");
        this.hours = hours;
        return this;
    }
     ...
     * The outstanding hours paid upon termination. This field is only applicable for termination payrolls.
     */
    public PayrollShowPaidTimeOff withFinalPayoutUnusedHoursInput(String finalPayoutUnusedHoursInput) {
        Utils.checkNotNull(finalPayoutUnusedHoursInput, "finalPayoutUnusedHoursInput");
     ...
     * The outstanding hours paid upon termination. This field is only applicable for termination payrolls.
     */
    public PayrollShowPaidTimeOff withFinalPayoutUnusedHoursInput(JsonNullable<String> finalPayoutUnusedHoursInput) {
        Utils.checkNotNull(finalPayoutUnusedHoursInput, "finalPayoutUnusedHoursInput");
        this.finalPayoutUnusedHoursInput = finalPayoutUnusedHoursInput;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PayrollShowPaidTimeOff other = (PayrollShowPaidTimeOff) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PayrollShowPaidTimeOff.class,
                "name", name,
                "hours", hours,
    ...
    public final static class Builder {
        ...
        public PayrollShowPaidTimeOff build() {

            return new PayrollShowPaidTimeOff(
                name, hours, finalPayoutUnusedHoursInput);
        }
