...
public class ContractorPaymentGroupWithBlockersTotals {
    /**
    ...
    @JsonCreator
    public ContractorPaymentGroupWithBlockersTotals(
     ...
     * The total amount for the group of contractor payments.
     */
    public ContractorPaymentGroupWithBlockersTotals withAmount(String amount) {
        Utils.checkNotNull(amount, "amount");
     ...
     * The total amount for the group of contractor payments.
     */
    public ContractorPaymentGroupWithBlockersTotals withAmount(Optional<String> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * The total debit amount for the group of contractor payments. Sum of wage &amp; reimbursement amount.
     */
    public ContractorPaymentGroupWithBlockersTotals withDebitAmount(String debitAmount) {
        Utils.checkNotNull(debitAmount, "debitAmount");
     ...
     * The total debit amount for the group of contractor payments. Sum of wage &amp; reimbursement amount.
     */
    public ContractorPaymentGroupWithBlockersTotals withDebitAmount(Optional<String> debitAmount) {
        Utils.checkNotNull(debitAmount, "debitAmount");
        this.debitAmount = debitAmount;
        return this;
    }
     ...
     * The total wage amount for the group of contractor payments.
     */
    public ContractorPaymentGroupWithBlockersTotals withWageAmount(String wageAmount) {
        Utils.checkNotNull(wageAmount, "wageAmount");
     ...
     * The total wage amount for the group of contractor payments.
     */
    public ContractorPaymentGroupWithBlockersTotals withWageAmount(Optional<String> wageAmount) {
        Utils.checkNotNull(wageAmount, "wageAmount");
        this.wageAmount = wageAmount;
        return this;
    }
     ...
     * The total reimbursement amount for the group of contractor payments.
     */
    public ContractorPaymentGroupWithBlockersTotals withReimbursementAmount(String reimbursementAmount) {
        Utils.checkNotNull(reimbursementAmount, "reimbursementAmount");
     ...
     * The total reimbursement amount for the group of contractor payments.
     */
    public ContractorPaymentGroupWithBlockersTotals withReimbursementAmount(Optional<String> reimbursementAmount) {
        Utils.checkNotNull(reimbursementAmount, "reimbursementAmount");
        this.reimbursementAmount = reimbursementAmount;
        return this;
    }
     ...
     * The total check amount for the group of contractor payments.
     */
    public ContractorPaymentGroupWithBlockersTotals withCheckAmount(String checkAmount) {
        Utils.checkNotNull(checkAmount, "checkAmount");
     ...
     * The total check amount for the group of contractor payments.
     */
    public ContractorPaymentGroupWithBlockersTotals withCheckAmount(Optional<String> checkAmount) {
        Utils.checkNotNull(checkAmount, "checkAmount");
        this.checkAmount = checkAmount;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ContractorPaymentGroupWithBlockersTotals other = (ContractorPaymentGroupWithBlockersTotals) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ContractorPaymentGroupWithBlockersTotals.class,
                "amount", amount,
    ...
    public final static class Builder {
        ...
        public ContractorPaymentGroupWithBlockersTotals build() {

            return new ContractorPaymentGroupWithBlockersTotals(
                amount, debitAmount, wageAmount,
                reimbursementAmount, checkAmount);
        }
