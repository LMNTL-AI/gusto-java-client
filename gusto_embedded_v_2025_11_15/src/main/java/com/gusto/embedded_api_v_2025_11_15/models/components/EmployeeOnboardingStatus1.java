...
public enum EmployeeOnboardingStatus1 {
    ...
    EmployeeOnboardingStatus1(String value) {
        this.value = value;
    }
    ...
    public static Optional<EmployeeOnboardingStatus1> fromValue(String value) {
        for (EmployeeOnboardingStatus1 o: EmployeeOnboardingStatus1.values()) {
