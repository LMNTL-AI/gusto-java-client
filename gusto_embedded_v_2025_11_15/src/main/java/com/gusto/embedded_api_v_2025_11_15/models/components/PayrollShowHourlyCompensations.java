...
public class PayrollShowHourlyCompensations {
    /**
    ...
    @JsonCreator
    public PayrollShowHourlyCompensations(
     ...
     * compensation.
     */
    public PayrollShowHourlyCompensations withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * compensation.
     */
    public PayrollShowHourlyCompensations withName(Optional<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The number of hours to be compensated for this pay period.
     */
    public PayrollShowHourlyCompensations withHours(String hours) {
        Utils.checkNotNull(hours, "hours");
     ...
     * The number of hours to be compensated for this pay period.
     */
    public PayrollShowHourlyCompensations withHours(Optional<String> hours) {
        Utils.checkNotNull(hours, "hours");
        this.hours = hours;
        return this;
    }
     ...
     * cannot be used for updating hourly compensations.
     */
    public PayrollShowHourlyCompensations withAmount(String amount) {
        Utils.checkNotNull(amount, "amount");
     ...
     * cannot be used for updating hourly compensations.
     */
    public PayrollShowHourlyCompensations withAmount(Optional<String> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * The UUID of the job for the compensation.
     */
    public PayrollShowHourlyCompensations withJobUuid(String jobUuid) {
        Utils.checkNotNull(jobUuid, "jobUuid");
     ...
     * The UUID of the job for the compensation.
     */
    public PayrollShowHourlyCompensations withJobUuid(Optional<String> jobUuid) {
        Utils.checkNotNull(jobUuid, "jobUuid");
        this.jobUuid = jobUuid;
        return this;
    }
     ...
     * The amount multiplied by the base rate to calculate total compensation per hour worked.
     */
    public PayrollShowHourlyCompensations withCompensationMultiplier(double compensationMultiplier) {
        Utils.checkNotNull(compensationMultiplier, "compensationMultiplier");
     ...
     * The amount multiplied by the base rate to calculate total compensation per hour worked.
     */
    public PayrollShowHourlyCompensations withCompensationMultiplier(Optional<Double> compensationMultiplier) {
        Utils.checkNotNull(compensationMultiplier, "compensationMultiplier");
        this.compensationMultiplier = compensationMultiplier;
        return this;
    }
     ...
     * The FLSA Status of the employee's primary job compensation
     */
    public PayrollShowHourlyCompensations withFlsaStatus(String flsaStatus) {
        Utils.checkNotNull(flsaStatus, "flsaStatus");
     ...
     * The FLSA Status of the employee's primary job compensation
     */
    public PayrollShowHourlyCompensations withFlsaStatus(Optional<String> flsaStatus) {
        Utils.checkNotNull(flsaStatus, "flsaStatus");
        this.flsaStatus = flsaStatus;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PayrollShowHourlyCompensations other = (PayrollShowHourlyCompensations) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PayrollShowHourlyCompensations.class,
                "name", name,
                "hours", hours,
                "amount", amount,
                "jobUuid", jobUuid,
    ...
    public final static class Builder {
        ...
        public PayrollShowHourlyCompensations build() {

            return new PayrollShowHourlyCompensations(
                name, hours, amount,
                jobUuid, compensationMultiplier, flsaStatus);
        }
