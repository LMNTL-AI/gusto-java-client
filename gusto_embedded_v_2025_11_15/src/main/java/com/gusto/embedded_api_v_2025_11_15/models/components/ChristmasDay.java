...
public class ChristmasDay {
    ...
    public ChristmasDay withSelected(boolean selected) {
        Utils.checkNotNull(selected, "selected");
    ...
    public ChristmasDay withSelected(Optional<Boolean> selected) {
        Utils.checkNotNull(selected, "selected");
        this.selected = selected;
        return this;
    }

    public ChristmasDay withName(String name) {
        Utils.checkNotNull(name, "name");
    ...
    public ChristmasDay withName(Optional<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public ChristmasDay withDate(String date) {
        Utils.checkNotNull(date, "date");
    ...
    public ChristmasDay withDate(Optional<String> date) {
        Utils.checkNotNull(date, "date");
        this.date = date;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ChristmasDay other = (ChristmasDay) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ChristmasDay.class,
                "selected", selected,
                "name", name,
                "date", date);
    }
