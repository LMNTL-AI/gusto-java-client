...
public class PayrollEmployeeCompensationsTypeHourlyCompensations {
    /**
    ...
    @JsonCreator
    public PayrollEmployeeCompensationsTypeHourlyCompensations(
     ...
     * compensation.
     */
    public PayrollEmployeeCompensationsTypeHourlyCompensations withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * compensation.
     */
    public PayrollEmployeeCompensationsTypeHourlyCompensations withName(Optional<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The number of hours to be compensated for this pay period.
     */
    public PayrollEmployeeCompensationsTypeHourlyCompensations withHours(String hours) {
        Utils.checkNotNull(hours, "hours");
     ...
     * The number of hours to be compensated for this pay period.
     */
    public PayrollEmployeeCompensationsTypeHourlyCompensations withHours(Optional<String> hours) {
        Utils.checkNotNull(hours, "hours");
        this.hours = hours;
        return this;
    }
     ...
     * cannot be used for updating hourly compensations.
     */
    public PayrollEmployeeCompensationsTypeHourlyCompensations withAmount(String amount) {
        Utils.checkNotNull(amount, "amount");
     ...
     * cannot be used for updating hourly compensations.
     */
    public PayrollEmployeeCompensationsTypeHourlyCompensations withAmount(Optional<String> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * The UUID of the job for the compensation.
     */
    public PayrollEmployeeCompensationsTypeHourlyCompensations withJobUuid(String jobUuid) {
        Utils.checkNotNull(jobUuid, "jobUuid");
     ...
     * The UUID of the job for the compensation.
     */
    public PayrollEmployeeCompensationsTypeHourlyCompensations withJobUuid(Optional<String> jobUuid) {
        Utils.checkNotNull(jobUuid, "jobUuid");
        this.jobUuid = jobUuid;
        return this;
    }
     ...
     * The amount multiplied by the base rate to calculate total compensation per hour worked.
     */
    public PayrollEmployeeCompensationsTypeHourlyCompensations withCompensationMultiplier(double compensationMultiplier) {
        Utils.checkNotNull(compensationMultiplier, "compensationMultiplier");
     ...
     * The amount multiplied by the base rate to calculate total compensation per hour worked.
     */
    public PayrollEmployeeCompensationsTypeHourlyCompensations withCompensationMultiplier(Optional<Double> compensationMultiplier) {
        Utils.checkNotNull(compensationMultiplier, "compensationMultiplier");
        this.compensationMultiplier = compensationMultiplier;
        return this;
    }
     ...
     * The FLSA Status of the employee's primary job compensation
     */
    public PayrollEmployeeCompensationsTypeHourlyCompensations withFlsaStatus(String flsaStatus) {
        Utils.checkNotNull(flsaStatus, "flsaStatus");
     ...
     * The FLSA Status of the employee's primary job compensation
     */
    public PayrollEmployeeCompensationsTypeHourlyCompensations withFlsaStatus(Optional<String> flsaStatus) {
        Utils.checkNotNull(flsaStatus, "flsaStatus");
        this.flsaStatus = flsaStatus;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PayrollEmployeeCompensationsTypeHourlyCompensations other = (PayrollEmployeeCompensationsTypeHourlyCompensations) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PayrollEmployeeCompensationsTypeHourlyCompensations.class,
                "name", name,
                "hours", hours,
                "amount", amount,
                "jobUuid", jobUuid,
    ...
    public final static class Builder {
        ...
        public PayrollEmployeeCompensationsTypeHourlyCompensations build() {

            return new PayrollEmployeeCompensationsTypeHourlyCompensations(
                name, hours, amount,
                jobUuid, compensationMultiplier, flsaStatus);
        }
