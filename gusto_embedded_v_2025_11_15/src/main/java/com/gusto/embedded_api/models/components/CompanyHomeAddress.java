...
public class CompanyHomeAddress {
    ...
    public CompanyHomeAddress withStreet1(String street1) {
        Utils.checkNotNull(street1, "street1");
    ...
    public CompanyHomeAddress withStreet1(Optional<String> street1) {
        Utils.checkNotNull(street1, "street1");
        this.street1 = street1;
        return this;
    }

    public CompanyHomeAddress withStreet2(String street2) {
        Utils.checkNotNull(street2, "street2");
        this.street2 = JsonNullable.of(street2);
        return this;
    }

    public CompanyHomeAddress withStreet2(JsonNullable<String> street2) {
        Utils.checkNotNull(street2, "street2");
        this.street2 = street2;
        return this;
    }

    public CompanyHomeAddress withCity(String city) {
        Utils.checkNotNull(city, "city");
    ...
    public CompanyHomeAddress withCity(Optional<String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }

    public CompanyHomeAddress withState(String state) {
        Utils.checkNotNull(state, "state");
    ...
    public CompanyHomeAddress withState(Optional<String> state) {
        Utils.checkNotNull(state, "state");
        this.state = state;
        return this;
    }

    public CompanyHomeAddress withZip(String zip) {
        Utils.checkNotNull(zip, "zip");
    ...
    public CompanyHomeAddress withZip(Optional<String> zip) {
        Utils.checkNotNull(zip, "zip");
        this.zip = zip;
        return this;
    }

    public CompanyHomeAddress withCountry(String country) {
        Utils.checkNotNull(country, "country");
    ...
    public CompanyHomeAddress withCountry(Optional<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CompanyHomeAddress other = (CompanyHomeAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CompanyHomeAddress.class,
                "street1", street1,
                "street2", street2,
                "city", city,
                "state", state,
    ...
    public final static class Builder {
        ...
        public CompanyHomeAddress build() {

            return new CompanyHomeAddress(
                street1, street2, city,
                state, zip, country);
        }
