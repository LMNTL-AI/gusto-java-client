...
public class Tiers {
     ...
     * The percentage of employee deduction within this tier the company contribution will match.
     */
    public Tiers withRate(String rate) {
        Utils.checkNotNull(rate, "rate");
     ...
     * The percentage of employee deduction within this tier the company contribution will match.
     */
    public Tiers withRate(Optional<String> rate) {
        Utils.checkNotNull(rate, "rate");
        this.rate = rate;
        return this;
    }
     ...
     * contributions from above 3% up to and including 5% of payroll.
     */
    public Tiers withThreshold(String threshold) {
        Utils.checkNotNull(threshold, "threshold");
     ...
     * contributions from above 3% up to and including 5% of payroll.
     */
    public Tiers withThreshold(Optional<String> threshold) {
        Utils.checkNotNull(threshold, "threshold");
        this.threshold = threshold;
        return this;
    }
     ...
     * tier, this is equivalent to threshold.
     */
    public Tiers withThresholdDelta(String thresholdDelta) {
        Utils.checkNotNull(thresholdDelta, "thresholdDelta");
     ...
     * tier, this is equivalent to threshold.
     */
    public Tiers withThresholdDelta(Optional<String> thresholdDelta) {
        Utils.checkNotNull(thresholdDelta, "thresholdDelta");
        this.thresholdDelta = thresholdDelta;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Tiers.class,
                "rate", rate,
                "threshold", threshold,
