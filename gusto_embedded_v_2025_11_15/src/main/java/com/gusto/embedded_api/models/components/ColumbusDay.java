...
public class ColumbusDay {
    ...
    public ColumbusDay withName(String name) {
        Utils.checkNotNull(name, "name");
    ...
    public ColumbusDay withName(Optional<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public ColumbusDay withDate(String date) {
        Utils.checkNotNull(date, "date");
    ...
    public ColumbusDay withDate(Optional<String> date) {
        Utils.checkNotNull(date, "date");
        this.date = date;
        return this;
    }
