...
public class MlkDay {
    ...
    public MlkDay withSelected(boolean selected) {
        Utils.checkNotNull(selected, "selected");
    ...
    public MlkDay withSelected(Optional<Boolean> selected) {
        Utils.checkNotNull(selected, "selected");
        this.selected = selected;
        return this;
    }

    public MlkDay withName(String name) {
        Utils.checkNotNull(name, "name");
    ...
    public MlkDay withName(Optional<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public MlkDay withDate(String date) {
        Utils.checkNotNull(date, "date");
    ...
    public MlkDay withDate(Optional<String> date) {
        Utils.checkNotNull(date, "date");
        this.date = date;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(MlkDay.class,
                "selected", selected,
                "name", name,
                "date", date);
    }
