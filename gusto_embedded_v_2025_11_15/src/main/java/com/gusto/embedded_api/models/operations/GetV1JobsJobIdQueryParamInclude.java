...
public enum GetV1JobsJobIdQueryParamInclude {
    ...
    GetV1JobsJobIdQueryParamInclude(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetV1JobsJobIdQueryParamInclude> fromValue(String value) {
        for (GetV1JobsJobIdQueryParamInclude o: GetV1JobsJobIdQueryParamInclude.values()) {
