...
public class VeteransDay {
    ...
    public VeteransDay withSelected(boolean selected) {
        Utils.checkNotNull(selected, "selected");
    ...
    public VeteransDay withSelected(Optional<Boolean> selected) {
        Utils.checkNotNull(selected, "selected");
        this.selected = selected;
        return this;
    }

    public VeteransDay withName(String name) {
        Utils.checkNotNull(name, "name");
    ...
    public VeteransDay withName(Optional<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public VeteransDay withDate(String date) {
        Utils.checkNotNull(date, "date");
    ...
    public VeteransDay withDate(Optional<String> date) {
        Utils.checkNotNull(date, "date");
        this.date = date;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VeteransDay other = (VeteransDay) o;
        return 
    ...
    public String toString() {
        return Utils.toString(VeteransDay.class,
                "selected", selected,
                "name", name,
                "date", date);
    }
    ...
    public final static class Builder {
        ...
        public VeteransDay build() {

            return new VeteransDay(
                selected, name, date);
        }
