...
public class PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
