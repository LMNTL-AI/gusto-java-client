...
public class Thanksgiving {
    ...
    public Thanksgiving withSelected(boolean selected) {
        Utils.checkNotNull(selected, "selected");
    ...
    public Thanksgiving withSelected(Optional<Boolean> selected) {
        Utils.checkNotNull(selected, "selected");
        this.selected = selected;
        return this;
    }

    public Thanksgiving withName(String name) {
        Utils.checkNotNull(name, "name");
    ...
    public Thanksgiving withName(Optional<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public Thanksgiving withDate(String date) {
        Utils.checkNotNull(date, "date");
    ...
    public Thanksgiving withDate(Optional<String> date) {
        Utils.checkNotNull(date, "date");
        this.date = date;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        Thanksgiving other = (Thanksgiving) o;
        return 
    ...
    public String toString() {
        return Utils.toString(Thanksgiving.class,
                "selected", selected,
                "name", name,
                "date", date);
    }
