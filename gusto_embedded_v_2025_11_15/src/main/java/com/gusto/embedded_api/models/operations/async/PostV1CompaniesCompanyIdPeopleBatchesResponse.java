...
public class PostV1CompaniesCompanyIdPeopleBatchesResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public PostV1CompaniesCompanyIdPeopleBatchesResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public PostV1CompaniesCompanyIdPeopleBatchesResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PostV1CompaniesCompanyIdPeopleBatchesResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PostV1CompaniesCompanyIdPeopleBatchesResponse other = (PostV1CompaniesCompanyIdPeopleBatchesResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PostV1CompaniesCompanyIdPeopleBatchesResponse.class,
    ...
    public final static class Builder {
        ...
        public PostV1CompaniesCompanyIdPeopleBatchesResponse build() {
