...
public class PresidentsDay {
    ...
    public PresidentsDay withName(String name) {
        Utils.checkNotNull(name, "name");
    ...
    public PresidentsDay withName(Optional<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public PresidentsDay withDate(String date) {
        Utils.checkNotNull(date, "date");
    ...
    public PresidentsDay withDate(Optional<String> date) {
        Utils.checkNotNull(date, "date");
        this.date = date;
        return this;
    }
