 ...
 */
public class EmployeeOnboardingDocumentsConfig {
    /**
    ...
    @JsonCreator
    public EmployeeOnboardingDocumentsConfig(
     ...
     * The UUID of the onboarding documents config
     */
    public EmployeeOnboardingDocumentsConfig withUuid(String uuid) {
        Utils.checkNotNull(uuid, "uuid");
     ...
     * The UUID of the onboarding documents config
     */
    public EmployeeOnboardingDocumentsConfig withUuid(JsonNullable<String> uuid) {
        Utils.checkNotNull(uuid, "uuid");
        this.uuid = uuid;
        return this;
    }
     ...
     * Whether to include Form I-9 for an employee during onboarding
     */
    public EmployeeOnboardingDocumentsConfig withI9Document(boolean i9Document) {
        Utils.checkNotNull(i9Document, "i9Document");
     ...
     * Whether to include Form I-9 for an employee during onboarding
     */
    public EmployeeOnboardingDocumentsConfig withI9Document(Optional<Boolean> i9Document) {
        Utils.checkNotNull(i9Document, "i9Document");
        this.i9Document = i9Document;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EmployeeOnboardingDocumentsConfig other = (EmployeeOnboardingDocumentsConfig) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EmployeeOnboardingDocumentsConfig.class,
                "uuid", uuid,
    ...
    public final static class Builder {
        ...
        public EmployeeOnboardingDocumentsConfig build() {

            return new EmployeeOnboardingDocumentsConfig(
                uuid, i9Document);
        }
