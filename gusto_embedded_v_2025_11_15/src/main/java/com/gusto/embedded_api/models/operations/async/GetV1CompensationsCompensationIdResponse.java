...
public class GetV1CompensationsCompensationIdResponse implements AsyncResponse {
    /**
    ...
    @JsonCreator
    public GetV1CompensationsCompensationIdResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetV1CompensationsCompensationIdResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetV1CompensationsCompensationIdResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetV1CompensationsCompensationIdResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetV1CompensationsCompensationIdResponse other = (GetV1CompensationsCompensationIdResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetV1CompensationsCompensationIdResponse.class,
    ...
    public final static class Builder {
        ...
        public GetV1CompensationsCompensationIdResponse build() {

            return new GetV1CompensationsCompensationIdResponse(
                contentType, statusCode, rawResponse,
                compensation);
        }
