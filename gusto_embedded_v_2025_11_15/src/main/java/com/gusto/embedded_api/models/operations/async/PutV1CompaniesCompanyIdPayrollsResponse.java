...
public class PutV1CompaniesCompanyIdPayrollsResponse implements AsyncResponse {
    /**
    ...
    @JsonCreator
    public PutV1CompaniesCompanyIdPayrollsResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public PutV1CompaniesCompanyIdPayrollsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public PutV1CompaniesCompanyIdPayrollsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PutV1CompaniesCompanyIdPayrollsResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PutV1CompaniesCompanyIdPayrollsResponse other = (PutV1CompaniesCompanyIdPayrollsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PutV1CompaniesCompanyIdPayrollsResponse.class,
    ...
    public final static class Builder {
        ...
        public PutV1CompaniesCompanyIdPayrollsResponse build() {

            return new PutV1CompaniesCompanyIdPayrollsResponse(
                contentType, statusCode, rawResponse,
                payrollPrepared);
        }
