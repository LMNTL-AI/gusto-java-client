...
public class PayrollEmployeeCompensationsTypePaidTimeOff {
     ...
     * The name of the PTO. This also serves as the unique, immutable identifier for the PTO.
     */
    public PayrollEmployeeCompensationsTypePaidTimeOff withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * The name of the PTO. This also serves as the unique, immutable identifier for the PTO.
     */
    public PayrollEmployeeCompensationsTypePaidTimeOff withName(Optional<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The hours of this PTO taken during the pay period.
     */
    public PayrollEmployeeCompensationsTypePaidTimeOff withHours(String hours) {
        Utils.checkNotNull(hours, "hours");
     ...
     * The hours of this PTO taken during the pay period.
     */
    public PayrollEmployeeCompensationsTypePaidTimeOff withHours(Optional<String> hours) {
        Utils.checkNotNull(hours, "hours");
        this.hours = hours;
        return this;
    }
     ...
     * The outstanding hours paid upon termination. This field is only applicable for termination payrolls.
     */
    public PayrollEmployeeCompensationsTypePaidTimeOff withFinalPayoutUnusedHoursInput(String finalPayoutUnusedHoursInput) {
        Utils.checkNotNull(finalPayoutUnusedHoursInput, "finalPayoutUnusedHoursInput");
     ...
     * The outstanding hours paid upon termination. This field is only applicable for termination payrolls.
     */
    public PayrollEmployeeCompensationsTypePaidTimeOff withFinalPayoutUnusedHoursInput(JsonNullable<String> finalPayoutUnusedHoursInput) {
        Utils.checkNotNull(finalPayoutUnusedHoursInput, "finalPayoutUnusedHoursInput");
        this.finalPayoutUnusedHoursInput = finalPayoutUnusedHoursInput;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PayrollEmployeeCompensationsTypePaidTimeOff other = (PayrollEmployeeCompensationsTypePaidTimeOff) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PayrollEmployeeCompensationsTypePaidTimeOff.class,
                "name", name,
                "hours", hours,
    ...
    public final static class Builder {
        ...
        public PayrollEmployeeCompensationsTypePaidTimeOff build() {

            return new PayrollEmployeeCompensationsTypePaidTimeOff(
                name, hours, finalPayoutUnusedHoursInput);
        }
