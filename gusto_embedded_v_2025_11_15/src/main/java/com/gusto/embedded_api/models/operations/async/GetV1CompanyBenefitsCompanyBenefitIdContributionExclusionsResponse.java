...
public class GetV1CompanyBenefitsCompanyBenefitIdContributionExclusionsResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetV1CompanyBenefitsCompanyBenefitIdContributionExclusionsResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
