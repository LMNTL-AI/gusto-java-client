...
public class Total {
     ...
     * The total reimbursements for contractor payments within a given time period.
     */
    public Total withReimbursements(String reimbursements) {
        Utils.checkNotNull(reimbursements, "reimbursements");
     ...
     * The total reimbursements for contractor payments within a given time period.
     */
    public Total withReimbursements(Optional<String> reimbursements) {
        Utils.checkNotNull(reimbursements, "reimbursements");
        this.reimbursements = reimbursements;
        return this;
    }
     ...
     * The total wages for contractor payments within a given time period.
     */
    public Total withWages(String wages) {
        Utils.checkNotNull(wages, "wages");
     ...
     * The total wages for contractor payments within a given time period.
     */
    public Total withWages(Optional<String> wages) {
        Utils.checkNotNull(wages, "wages");
        this.wages = wages;
        return this;
    }
