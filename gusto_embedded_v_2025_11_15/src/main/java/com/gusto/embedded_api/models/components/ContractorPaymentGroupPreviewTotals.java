...
public class ContractorPaymentGroupPreviewTotals {
    /**
    ...
    @JsonCreator
    public ContractorPaymentGroupPreviewTotals(
     ...
     * The total amount for the group of contractor payments.
     */
    public ContractorPaymentGroupPreviewTotals withAmount(String amount) {
        Utils.checkNotNull(amount, "amount");
     ...
     * The total amount for the group of contractor payments.
     */
    public ContractorPaymentGroupPreviewTotals withAmount(Optional<String> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
     ...
     * The total debit amount for the group of contractor payments. Sum of wage &amp; reimbursement amount.
     */
    public ContractorPaymentGroupPreviewTotals withDebitAmount(String debitAmount) {
        Utils.checkNotNull(debitAmount, "debitAmount");
     ...
     * The total debit amount for the group of contractor payments. Sum of wage &amp; reimbursement amount.
     */
    public ContractorPaymentGroupPreviewTotals withDebitAmount(Optional<String> debitAmount) {
        Utils.checkNotNull(debitAmount, "debitAmount");
        this.debitAmount = debitAmount;
        return this;
    }
     ...
     * The total wage amount for the group of contractor payments.
     */
    public ContractorPaymentGroupPreviewTotals withWageAmount(String wageAmount) {
        Utils.checkNotNull(wageAmount, "wageAmount");
     ...
     * The total wage amount for the group of contractor payments.
     */
    public ContractorPaymentGroupPreviewTotals withWageAmount(Optional<String> wageAmount) {
        Utils.checkNotNull(wageAmount, "wageAmount");
        this.wageAmount = wageAmount;
        return this;
    }
     ...
     * The total reimbursement amount for the group of contractor payments.
     */
    public ContractorPaymentGroupPreviewTotals withReimbursementAmount(String reimbursementAmount) {
        Utils.checkNotNull(reimbursementAmount, "reimbursementAmount");
     ...
     * The total reimbursement amount for the group of contractor payments.
     */
    public ContractorPaymentGroupPreviewTotals withReimbursementAmount(Optional<String> reimbursementAmount) {
        Utils.checkNotNull(reimbursementAmount, "reimbursementAmount");
        this.reimbursementAmount = reimbursementAmount;
        return this;
    }
     ...
     * The total check amount for the group of contractor payments.
     */
    public ContractorPaymentGroupPreviewTotals withCheckAmount(String checkAmount) {
        Utils.checkNotNull(checkAmount, "checkAmount");
     ...
     * The total check amount for the group of contractor payments.
     */
    public ContractorPaymentGroupPreviewTotals withCheckAmount(Optional<String> checkAmount) {
        Utils.checkNotNull(checkAmount, "checkAmount");
        this.checkAmount = checkAmount;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ContractorPaymentGroupPreviewTotals other = (ContractorPaymentGroupPreviewTotals) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ContractorPaymentGroupPreviewTotals.class,
                "amount", amount,
    ...
    public final static class Builder {
        ...
        public ContractorPaymentGroupPreviewTotals build() {

            return new ContractorPaymentGroupPreviewTotals(
                amount, debitAmount, wageAmount,
                reimbursementAmount, checkAmount);
        }
