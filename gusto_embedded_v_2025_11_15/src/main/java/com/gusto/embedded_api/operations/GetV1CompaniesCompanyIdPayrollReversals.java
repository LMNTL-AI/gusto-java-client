...
public class GetV1CompaniesCompanyIdPayrollReversals {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetV1CompaniesCompanyIdPayrollReversalsRequest, GetV1CompaniesCompanyIdPayrollReversalsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetV1CompaniesCompanyIdPayrollReversalsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetV1CompaniesCompanyIdPayrollReversalsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesCompanyIdPayrollReversalsRequest request) {
        ...
        @Override
        public GetV1CompaniesCompanyIdPayrollReversalsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetV1CompaniesCompanyIdPayrollReversalsResponse.Builder resBuilder =
            ...
            GetV1CompaniesCompanyIdPayrollReversalsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "2XX")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPayrollReversalList(Utils.unmarshal(response, new TypeReference<List<PayrollReversal>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyIdPayrollReversalsRequest, com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdPayrollReversalsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetV1CompaniesCompanyIdPayrollReversalsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetV1CompaniesCompanyIdPayrollReversalsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetV1CompaniesCompanyIdPayrollReversalsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdPayrollReversalsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdPayrollReversalsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdPayrollReversalsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdPayrollReversalsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "2XX")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<PayrollReversal>>() {})
                            .thenApply(res::withPayrollReversalList);
                } else {
