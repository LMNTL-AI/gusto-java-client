...
public class GetV1CompaniesCompanyUuidTaxRequirementsState {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyUuidTaxRequirementsStateRequest, com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyUuidTaxRequirementsStateResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyUuidTaxRequirementsStateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyUuidTaxRequirementsStateResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyUuidTaxRequirementsStateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyUuidTaxRequirementsStateResponse res = resBuilder.build();
