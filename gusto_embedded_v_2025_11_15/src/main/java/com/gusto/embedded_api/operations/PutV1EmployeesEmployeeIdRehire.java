...
public class PutV1EmployeesEmployeeIdRehire {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1EmployeesEmployeeIdRehireRequest, com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdRehireResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdRehireResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdRehireResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdRehireResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdRehireResponse res = resBuilder.build();
