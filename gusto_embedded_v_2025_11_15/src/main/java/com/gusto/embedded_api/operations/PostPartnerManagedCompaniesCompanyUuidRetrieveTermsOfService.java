...
public class PostPartnerManagedCompaniesCompanyUuidRetrieveTermsOfService {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostPartnerManagedCompaniesCompanyUuidRetrieveTermsOfServiceRequest, com.gusto.embedded_api.models.operations.async.PostPartnerManagedCompaniesCompanyUuidRetrieveTermsOfServiceResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostPartnerManagedCompaniesCompanyUuidRetrieveTermsOfServiceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostPartnerManagedCompaniesCompanyUuidRetrieveTermsOfServiceResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostPartnerManagedCompaniesCompanyUuidRetrieveTermsOfServiceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostPartnerManagedCompaniesCompanyUuidRetrieveTermsOfServiceResponse res = resBuilder.build();
