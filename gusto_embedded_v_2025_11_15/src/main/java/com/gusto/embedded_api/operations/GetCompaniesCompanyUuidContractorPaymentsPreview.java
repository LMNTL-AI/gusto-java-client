...
public class GetCompaniesCompanyUuidContractorPaymentsPreview {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCompaniesCompanyUuidContractorPaymentsPreviewRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetCompaniesCompanyUuidContractorPaymentsPreviewResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetCompaniesCompanyUuidContractorPaymentsPreviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetCompaniesCompanyUuidContractorPaymentsPreviewResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetCompaniesCompanyUuidContractorPaymentsPreviewResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetCompaniesCompanyUuidContractorPaymentsPreviewResponse res = resBuilder.build();
