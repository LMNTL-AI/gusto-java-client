...
import com.gusto.embedded_api_v_2025_11_15.models.components.EmployeePaymentDetailsList;
...
public class GetV1CompaniesCompanyIdEmployeesPaymentDetails {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyIdEmployeesPaymentDetailsRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompaniesCompanyIdEmployeesPaymentDetailsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompaniesCompanyIdEmployeesPaymentDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompaniesCompanyIdEmployeesPaymentDetailsResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompaniesCompanyIdEmployeesPaymentDetailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompaniesCompanyIdEmployeesPaymentDetailsResponse res = resBuilder.build();
