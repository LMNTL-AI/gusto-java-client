...
public class GetV1CompanyPaymentConfigs {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompanyPaymentConfigsRequest, com.gusto.embedded_api.models.operations.async.GetV1CompanyPaymentConfigsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompanyPaymentConfigsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompanyPaymentConfigsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompanyPaymentConfigsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompanyPaymentConfigsResponse res = resBuilder.build();
