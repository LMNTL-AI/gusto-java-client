...
public class GetV1CompaniesCompanyIdBankAccounts {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyIdBankAccountsRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompaniesCompanyIdBankAccountsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompaniesCompanyIdBankAccountsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompaniesCompanyIdBankAccountsResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompaniesCompanyIdBankAccountsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompaniesCompanyIdBankAccountsResponse res = resBuilder.build();
