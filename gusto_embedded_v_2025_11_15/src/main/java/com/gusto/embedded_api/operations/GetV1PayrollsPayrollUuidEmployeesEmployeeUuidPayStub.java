...
public class GetV1PayrollsPayrollUuidEmployeesEmployeeUuidPayStub {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1PayrollsPayrollUuidEmployeesEmployeeUuidPayStubRequest, com.gusto.embedded_api.models.operations.async.GetV1PayrollsPayrollUuidEmployeesEmployeeUuidPayStubResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1PayrollsPayrollUuidEmployeesEmployeeUuidPayStubResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1PayrollsPayrollUuidEmployeesEmployeeUuidPayStubResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1PayrollsPayrollUuidEmployeesEmployeeUuidPayStubResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            com.gusto.embedded_api.models.operations.async.GetV1PayrollsPayrollUuidEmployeesEmployeeUuidPayStubResponse res = resBuilder.build();
