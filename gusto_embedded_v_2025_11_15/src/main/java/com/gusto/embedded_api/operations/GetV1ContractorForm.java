...
public class GetV1ContractorForm {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ContractorFormRequest, com.gusto.embedded_api.models.operations.async.GetV1ContractorFormResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1ContractorFormResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1ContractorFormResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1ContractorFormResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1ContractorFormResponse res = resBuilder.build();
