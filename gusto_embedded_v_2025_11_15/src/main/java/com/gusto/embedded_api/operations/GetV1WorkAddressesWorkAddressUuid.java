...
public class GetV1WorkAddressesWorkAddressUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1WorkAddressesWorkAddressUuidRequest, com.gusto.embedded_api.models.operations.async.GetV1WorkAddressesWorkAddressUuidResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1WorkAddressesWorkAddressUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1WorkAddressesWorkAddressUuidResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1WorkAddressesWorkAddressUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1WorkAddressesWorkAddressUuidResponse res = resBuilder.build();
