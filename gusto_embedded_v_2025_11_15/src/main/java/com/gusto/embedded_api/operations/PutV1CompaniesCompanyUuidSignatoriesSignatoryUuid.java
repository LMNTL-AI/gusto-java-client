...
public class PutV1CompaniesCompanyUuidSignatoriesSignatoryUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidRequest, com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse res = resBuilder.build();
