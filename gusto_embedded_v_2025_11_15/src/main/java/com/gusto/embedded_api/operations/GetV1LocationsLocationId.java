...
public class GetV1LocationsLocationId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1LocationsLocationIdRequest, com.gusto.embedded_api.models.operations.async.GetV1LocationsLocationIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1LocationsLocationIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1LocationsLocationIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1LocationsLocationIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1LocationsLocationIdResponse res = resBuilder.build();
