...
import com.gusto.embedded_api.models.operations.GetV1PeopleBatchesPeopleBatchUuidRequest;
...
public class GetV1PeopleBatchesPeopleBatchUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1PeopleBatchesPeopleBatchUuidRequest, com.gusto.embedded_api.models.operations.async.GetV1PeopleBatchesPeopleBatchUuidResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1PeopleBatchesPeopleBatchUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1PeopleBatchesPeopleBatchUuidResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1PeopleBatchesPeopleBatchUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1PeopleBatchesPeopleBatchUuidResponse res = resBuilder.build();
