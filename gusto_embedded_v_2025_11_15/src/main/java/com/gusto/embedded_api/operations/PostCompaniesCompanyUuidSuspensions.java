...
public class PostCompaniesCompanyUuidSuspensions {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostCompaniesCompanyUuidSuspensionsRequest, com.gusto.embedded_api.models.operations.async.PostCompaniesCompanyUuidSuspensionsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostCompaniesCompanyUuidSuspensionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostCompaniesCompanyUuidSuspensionsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostCompaniesCompanyUuidSuspensionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostCompaniesCompanyUuidSuspensionsResponse res = resBuilder.build();
