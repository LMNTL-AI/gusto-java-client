...
public class GetV1EmployeesEmployeeIdOnboardingStatus {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1EmployeesEmployeeIdOnboardingStatusRequest, com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdOnboardingStatusResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdOnboardingStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdOnboardingStatusResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdOnboardingStatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdOnboardingStatusResponse res = resBuilder.build();
