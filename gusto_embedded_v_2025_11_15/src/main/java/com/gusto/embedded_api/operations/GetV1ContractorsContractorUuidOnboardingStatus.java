...
public class GetV1ContractorsContractorUuidOnboardingStatus {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ContractorsContractorUuidOnboardingStatusRequest, com.gusto.embedded_api.models.operations.async.GetV1ContractorsContractorUuidOnboardingStatusResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1ContractorsContractorUuidOnboardingStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1ContractorsContractorUuidOnboardingStatusResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1ContractorsContractorUuidOnboardingStatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1ContractorsContractorUuidOnboardingStatusResponse res = resBuilder.build();
