...
public class GetV1CompensationsCompensationId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompensationsCompensationIdRequest, com.gusto.embedded_api.models.operations.async.GetV1CompensationsCompensationIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompensationsCompensationIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompensationsCompensationIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompensationsCompensationIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompensationsCompensationIdResponse res = resBuilder.build();
