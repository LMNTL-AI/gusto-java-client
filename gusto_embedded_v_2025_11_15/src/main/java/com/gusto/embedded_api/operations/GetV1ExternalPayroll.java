...
public class GetV1ExternalPayroll {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ExternalPayrollRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1ExternalPayrollResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1ExternalPayrollResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1ExternalPayrollResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1ExternalPayrollResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1ExternalPayrollResponse res = resBuilder.build();
