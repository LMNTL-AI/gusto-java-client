...
public class GetV1CompaniesCompanyIdPaySchedulesPayScheduleId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyIdPaySchedulesPayScheduleIdRequest, com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesPayScheduleIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesPayScheduleIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesPayScheduleIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesPayScheduleIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesPayScheduleIdResponse res = resBuilder.build();
