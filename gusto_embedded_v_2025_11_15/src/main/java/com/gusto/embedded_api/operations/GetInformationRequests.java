...
public class GetInformationRequests {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetInformationRequestsRequest, com.gusto.embedded_api.models.operations.async.GetInformationRequestsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetInformationRequestsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetInformationRequestsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetInformationRequestsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetInformationRequestsResponse res = resBuilder.build();
