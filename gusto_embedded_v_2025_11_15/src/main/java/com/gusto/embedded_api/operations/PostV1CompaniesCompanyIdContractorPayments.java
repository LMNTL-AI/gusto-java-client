...
public class PostV1CompaniesCompanyIdContractorPayments {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompaniesCompanyIdContractorPaymentsRequest, com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdContractorPaymentsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdContractorPaymentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdContractorPaymentsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdContractorPaymentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdContractorPaymentsResponse res = resBuilder.build();
