...
public class GetRecoveryCases {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRecoveryCasesRequest, com.gusto.embedded_api.models.operations.async.GetRecoveryCasesResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetRecoveryCasesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetRecoveryCasesResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetRecoveryCasesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetRecoveryCasesResponse res = resBuilder.build();
