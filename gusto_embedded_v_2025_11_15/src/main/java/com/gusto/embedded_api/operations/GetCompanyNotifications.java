...
public class GetCompanyNotifications {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCompanyNotificationsRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetCompanyNotificationsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetCompanyNotificationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetCompanyNotificationsResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetCompanyNotificationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetCompanyNotificationsResponse res = resBuilder.build();
