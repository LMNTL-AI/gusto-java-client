...
public class GetV1ContractorPaymentsContractorPaymentIdPdf {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ContractorPaymentsContractorPaymentIdPdfRequest, com.gusto.embedded_api.models.operations.async.GetV1ContractorPaymentsContractorPaymentIdPdfResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1ContractorPaymentsContractorPaymentIdPdfResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1ContractorPaymentsContractorPaymentIdPdfResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1ContractorPaymentsContractorPaymentIdPdfResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1ContractorPaymentsContractorPaymentIdPdfResponse res = resBuilder.build();
