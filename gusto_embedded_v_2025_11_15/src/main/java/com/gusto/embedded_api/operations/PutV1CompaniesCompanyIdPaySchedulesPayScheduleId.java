...
public class PutV1CompaniesCompanyIdPaySchedulesPayScheduleId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesCompanyIdPaySchedulesPayScheduleIdRequest, com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdPaySchedulesPayScheduleIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdPaySchedulesPayScheduleIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdPaySchedulesPayScheduleIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdPaySchedulesPayScheduleIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
