...
public class PutV1TimeOffPoliciesTimeOffPolicyUuidBalance {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1TimeOffPoliciesTimeOffPolicyUuidBalanceRequest, com.gusto.embedded_api.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidBalanceResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidBalanceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidBalanceResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidBalanceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidBalanceResponse res = resBuilder.build();
