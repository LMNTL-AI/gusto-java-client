...
public class SubmitInformationRequest {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SubmitInformationRequestRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.SubmitInformationRequestResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.SubmitInformationRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.SubmitInformationRequestResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.SubmitInformationRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
