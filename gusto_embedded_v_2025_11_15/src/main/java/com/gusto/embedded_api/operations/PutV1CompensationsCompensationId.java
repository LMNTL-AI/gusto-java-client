...
public class PutV1CompensationsCompensationId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompensationsCompensationIdRequest, com.gusto.embedded_api.models.operations.async.PutV1CompensationsCompensationIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1CompensationsCompensationIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1CompensationsCompensationIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1CompensationsCompensationIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1CompensationsCompensationIdResponse res = resBuilder.build();
