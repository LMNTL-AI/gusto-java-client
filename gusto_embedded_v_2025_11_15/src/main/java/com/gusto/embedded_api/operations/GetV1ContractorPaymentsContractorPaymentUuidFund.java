...
public class GetV1ContractorPaymentsContractorPaymentUuidFund {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ContractorPaymentsContractorPaymentUuidFundRequest, com.gusto.embedded_api.models.operations.async.GetV1ContractorPaymentsContractorPaymentUuidFundResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1ContractorPaymentsContractorPaymentUuidFundResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1ContractorPaymentsContractorPaymentUuidFundResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1ContractorPaymentsContractorPaymentUuidFundResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1ContractorPaymentsContractorPaymentUuidFundResponse res = resBuilder.build();
