...
public class GetV1PaymentReceiptsPayrollsPayrollUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1PaymentReceiptsPayrollsPayrollUuidRequest, com.gusto.embedded_api.models.operations.async.GetV1PaymentReceiptsPayrollsPayrollUuidResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1PaymentReceiptsPayrollsPayrollUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1PaymentReceiptsPayrollsPayrollUuidResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1PaymentReceiptsPayrollsPayrollUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1PaymentReceiptsPayrollsPayrollUuidResponse res = resBuilder.build();
