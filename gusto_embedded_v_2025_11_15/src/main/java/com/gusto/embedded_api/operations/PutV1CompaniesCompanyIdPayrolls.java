...
public class PutV1CompaniesCompanyIdPayrolls {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesCompanyIdPayrollsRequest, com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdPayrollsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdPayrollsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdPayrollsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdPayrollsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdPayrollsResponse res = resBuilder.build();
