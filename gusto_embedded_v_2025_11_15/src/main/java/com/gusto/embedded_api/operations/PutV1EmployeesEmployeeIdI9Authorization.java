...
import com.gusto.embedded_api_v_2025_11_15.models.components.I9Authorization;
...
public class PutV1EmployeesEmployeeIdI9Authorization {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1EmployeesEmployeeIdI9AuthorizationRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1EmployeesEmployeeIdI9AuthorizationResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1EmployeesEmployeeIdI9AuthorizationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1EmployeesEmployeeIdI9AuthorizationResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1EmployeesEmployeeIdI9AuthorizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1EmployeesEmployeeIdI9AuthorizationResponse res = resBuilder.build();
