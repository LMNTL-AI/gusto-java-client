...
public class GetV1CompanyFinishOnboarding {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompanyFinishOnboardingRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompanyFinishOnboardingResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompanyFinishOnboardingResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompanyFinishOnboardingResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompanyFinishOnboardingResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1CompanyFinishOnboardingResponse res = resBuilder.build();
