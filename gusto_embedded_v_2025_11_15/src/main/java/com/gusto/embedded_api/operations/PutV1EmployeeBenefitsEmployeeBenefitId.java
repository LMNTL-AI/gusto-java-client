...
public class PutV1EmployeeBenefitsEmployeeBenefitId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1EmployeeBenefitsEmployeeBenefitIdRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1EmployeeBenefitsEmployeeBenefitIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1EmployeeBenefitsEmployeeBenefitIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1EmployeeBenefitsEmployeeBenefitIdResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1EmployeeBenefitsEmployeeBenefitIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1EmployeeBenefitsEmployeeBenefitIdResponse res = resBuilder.build();
