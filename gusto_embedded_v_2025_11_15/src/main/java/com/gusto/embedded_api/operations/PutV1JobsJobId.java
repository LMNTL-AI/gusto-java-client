...
public class PutV1JobsJobId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1JobsJobIdRequest, com.gusto.embedded_api.models.operations.async.PutV1JobsJobIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1JobsJobIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1JobsJobIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1JobsJobIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1JobsJobIdResponse res = resBuilder.build();
