...
Developer-friendly & type-safe Java SDK specifically catered to leverage *GustoEmbedded* API.

[![Built by Speakeasy](https://img.shields.io/badge/Built_by-SPEAKEASY-374151?style=for-the-badge&labelColor=f3f4f6)](https://www.speakeasy.com/?utm_source=gusto-embedded&utm_campaign=java)
...
Gradle:
```groovy
implementation 'com.gusto:embedded-api-v-2025-11-15:0.0.2'
```
...
<dependency>
    ...
    <artifactId>embedded-api-v-2025-11-15</artifactId>
...
### SDK Created by [Speakeasy](https://www.speakeasy.com/?utm_source=gusto-embedded&utm_campaign=java)
