...
public class GetV1CompanyBenefitsCompanyBenefitIdEmployeeBenefits {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsRequest, com.gusto.embedded_api.models.operations.async.GetV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsResponse res = resBuilder.build();
