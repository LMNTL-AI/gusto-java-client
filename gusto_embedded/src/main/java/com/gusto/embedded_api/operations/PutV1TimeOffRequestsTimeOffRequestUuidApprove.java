...
import com.gusto.embedded_api.models.operations.PutV1TimeOffRequestsTimeOffRequestUuidApproveRequest;
...
public class PutV1TimeOffRequestsTimeOffRequestUuidApprove {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1TimeOffRequestsTimeOffRequestUuidApproveRequest, com.gusto.embedded_api.models.operations.async.PutV1TimeOffRequestsTimeOffRequestUuidApproveResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1TimeOffRequestsTimeOffRequestUuidApproveResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1TimeOffRequestsTimeOffRequestUuidApproveResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1TimeOffRequestsTimeOffRequestUuidApproveResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1TimeOffRequestsTimeOffRequestUuidApproveResponse res = resBuilder.build();
