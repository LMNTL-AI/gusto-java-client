...
public class PutV1CompaniesCompanyUuidTaxRequirementsState {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesCompanyUuidTaxRequirementsStateRequest, com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyUuidTaxRequirementsStateResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyUuidTaxRequirementsStateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyUuidTaxRequirementsStateResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyUuidTaxRequirementsStateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyUuidTaxRequirementsStateResponse res = resBuilder.build();
