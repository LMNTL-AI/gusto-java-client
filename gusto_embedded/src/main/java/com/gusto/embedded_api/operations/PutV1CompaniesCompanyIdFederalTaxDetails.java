...
public class PutV1CompaniesCompanyIdFederalTaxDetails {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesCompanyIdFederalTaxDetailsRequest, com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdFederalTaxDetailsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdFederalTaxDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdFederalTaxDetailsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdFederalTaxDetailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdFederalTaxDetailsResponse res = resBuilder.build();
