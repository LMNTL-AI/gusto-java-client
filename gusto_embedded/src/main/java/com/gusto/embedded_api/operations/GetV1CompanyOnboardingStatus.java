...
public class GetV1CompanyOnboardingStatus {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompanyOnboardingStatusRequest, com.gusto.embedded_api.models.operations.async.GetV1CompanyOnboardingStatusResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompanyOnboardingStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompanyOnboardingStatusResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompanyOnboardingStatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompanyOnboardingStatusResponse res = resBuilder.build();
