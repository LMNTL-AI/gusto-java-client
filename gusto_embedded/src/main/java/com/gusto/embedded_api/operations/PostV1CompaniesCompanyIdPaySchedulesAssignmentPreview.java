...
public class PostV1CompaniesCompanyIdPaySchedulesAssignmentPreview {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompaniesCompanyIdPaySchedulesAssignmentPreviewRequest, com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdPaySchedulesAssignmentPreviewResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdPaySchedulesAssignmentPreviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdPaySchedulesAssignmentPreviewResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdPaySchedulesAssignmentPreviewResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdPaySchedulesAssignmentPreviewResponse res = resBuilder.build();
