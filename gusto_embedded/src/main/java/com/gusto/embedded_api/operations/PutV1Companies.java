...
public class PutV1Companies {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesRequest, com.gusto.embedded_api.models.operations.async.PutV1CompaniesResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1CompaniesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1CompaniesResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1CompaniesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1CompaniesResponse res = resBuilder.build();
