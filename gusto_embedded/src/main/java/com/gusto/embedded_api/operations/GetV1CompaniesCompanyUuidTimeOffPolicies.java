...
public class GetV1CompaniesCompanyUuidTimeOffPolicies {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyUuidTimeOffPoliciesRequest, com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyUuidTimeOffPoliciesResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyUuidTimeOffPoliciesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyUuidTimeOffPoliciesResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyUuidTimeOffPoliciesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyUuidTimeOffPoliciesResponse res = resBuilder.build();
