...
public class GetV1EmployeesEmployeeIdI9AuthorizationDocumentOptions {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1EmployeesEmployeeIdI9AuthorizationDocumentOptionsRequest, com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdI9AuthorizationDocumentOptionsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdI9AuthorizationDocumentOptionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdI9AuthorizationDocumentOptionsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdI9AuthorizationDocumentOptionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdI9AuthorizationDocumentOptionsResponse res = resBuilder.build();
