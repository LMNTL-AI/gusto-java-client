...
import com.gusto.embedded_api.models.operations.PutV1TimeOffRequestsTimeOffRequestUuidDeclineRequest;
import com.gusto.embedded_api.models.operations.PutV1TimeOffRequestsTimeOffRequestUuidDeclineResponse;
...
public class PutV1TimeOffRequestsTimeOffRequestUuidDecline {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1TimeOffRequestsTimeOffRequestUuidDeclineRequest, com.gusto.embedded_api.models.operations.async.PutV1TimeOffRequestsTimeOffRequestUuidDeclineResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1TimeOffRequestsTimeOffRequestUuidDeclineResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1TimeOffRequestsTimeOffRequestUuidDeclineResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1TimeOffRequestsTimeOffRequestUuidDeclineResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1TimeOffRequestsTimeOffRequestUuidDeclineResponse res = resBuilder.build();
