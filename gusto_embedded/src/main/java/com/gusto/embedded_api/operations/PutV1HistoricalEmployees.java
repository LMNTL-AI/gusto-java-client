...
public class PutV1HistoricalEmployees {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1HistoricalEmployeesRequest, com.gusto.embedded_api.models.operations.async.PutV1HistoricalEmployeesResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1HistoricalEmployeesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1HistoricalEmployeesResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1HistoricalEmployeesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1HistoricalEmployeesResponse res = resBuilder.build();
