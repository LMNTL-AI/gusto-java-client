...
public class PutApiV1CompaniesCompanyIdPayrollsPayrollIdCancel {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutApiV1CompaniesCompanyIdPayrollsPayrollIdCancelRequest, com.gusto.embedded_api.models.operations.async.PutApiV1CompaniesCompanyIdPayrollsPayrollIdCancelResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutApiV1CompaniesCompanyIdPayrollsPayrollIdCancelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutApiV1CompaniesCompanyIdPayrollsPayrollIdCancelResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutApiV1CompaniesCompanyIdPayrollsPayrollIdCancelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutApiV1CompaniesCompanyIdPayrollsPayrollIdCancelResponse res = resBuilder.build();
