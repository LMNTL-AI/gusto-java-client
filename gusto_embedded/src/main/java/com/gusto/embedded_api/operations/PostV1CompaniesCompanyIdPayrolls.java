...
public class PostV1CompaniesCompanyIdPayrolls {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompaniesCompanyIdPayrollsRequest, com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdPayrollsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdPayrollsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdPayrollsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdPayrollsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdPayrollsResponse res = resBuilder.build();
