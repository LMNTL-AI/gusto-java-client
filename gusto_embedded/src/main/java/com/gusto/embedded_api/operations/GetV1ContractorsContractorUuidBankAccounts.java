...
public class GetV1ContractorsContractorUuidBankAccounts {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ContractorsContractorUuidBankAccountsRequest, com.gusto.embedded_api.models.operations.async.GetV1ContractorsContractorUuidBankAccountsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1ContractorsContractorUuidBankAccountsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1ContractorsContractorUuidBankAccountsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1ContractorsContractorUuidBankAccountsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1ContractorsContractorUuidBankAccountsResponse res = resBuilder.build();
