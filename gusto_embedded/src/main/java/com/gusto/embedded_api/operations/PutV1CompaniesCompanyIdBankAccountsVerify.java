...
public class PutV1CompaniesCompanyIdBankAccountsVerify {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesCompanyIdBankAccountsVerifyRequest, com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdBankAccountsVerifyResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdBankAccountsVerifyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdBankAccountsVerifyResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdBankAccountsVerifyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdBankAccountsVerifyResponse res = resBuilder.build();
