...
public class PutV1CompanyBenefitsCompanyBenefitIdContributionExclusions {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompanyBenefitsCompanyBenefitIdContributionExclusionsRequest, com.gusto.embedded_api.models.operations.async.PutV1CompanyBenefitsCompanyBenefitIdContributionExclusionsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1CompanyBenefitsCompanyBenefitIdContributionExclusionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1CompanyBenefitsCompanyBenefitIdContributionExclusionsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1CompanyBenefitsCompanyBenefitIdContributionExclusionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1CompanyBenefitsCompanyBenefitIdContributionExclusionsResponse res = resBuilder.build();
