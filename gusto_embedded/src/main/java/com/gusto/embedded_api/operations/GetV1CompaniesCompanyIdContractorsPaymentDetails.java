...
import com.gusto.embedded_api.models.components.ContractorPaymentDetailsList;
...
public class GetV1CompaniesCompanyIdContractorsPaymentDetails {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyIdContractorsPaymentDetailsRequest, com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdContractorsPaymentDetailsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdContractorsPaymentDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdContractorsPaymentDetailsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdContractorsPaymentDetailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdContractorsPaymentDetailsResponse res = resBuilder.build();
