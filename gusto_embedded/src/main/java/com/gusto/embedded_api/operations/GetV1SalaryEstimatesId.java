...
public class GetV1SalaryEstimatesId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1SalaryEstimatesIdRequest, com.gusto.embedded_api.models.operations.async.GetV1SalaryEstimatesIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1SalaryEstimatesIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1SalaryEstimatesIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1SalaryEstimatesIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1SalaryEstimatesIdResponse res = resBuilder.build();
