...
public class GetV1EmployeesEmployeeIdBankAccounts {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1EmployeesEmployeeIdBankAccountsRequest, com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdBankAccountsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdBankAccountsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdBankAccountsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdBankAccountsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdBankAccountsResponse res = resBuilder.build();
