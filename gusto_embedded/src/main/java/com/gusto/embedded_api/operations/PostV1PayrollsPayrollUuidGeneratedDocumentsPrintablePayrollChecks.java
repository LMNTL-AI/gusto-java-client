...
public class PostV1PayrollsPayrollUuidGeneratedDocumentsPrintablePayrollChecks {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1PayrollsPayrollUuidGeneratedDocumentsPrintablePayrollChecksRequest, com.gusto.embedded_api.models.operations.async.PostV1PayrollsPayrollUuidGeneratedDocumentsPrintablePayrollChecksResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1PayrollsPayrollUuidGeneratedDocumentsPrintablePayrollChecksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1PayrollsPayrollUuidGeneratedDocumentsPrintablePayrollChecksResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1PayrollsPayrollUuidGeneratedDocumentsPrintablePayrollChecksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1PayrollsPayrollUuidGeneratedDocumentsPrintablePayrollChecksResponse res = resBuilder.build();
