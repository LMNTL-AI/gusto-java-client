...
public class PutV1ContractorsContractorUuidOnboardingStatus {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1ContractorsContractorUuidOnboardingStatusRequest, com.gusto.embedded_api.models.operations.async.PutV1ContractorsContractorUuidOnboardingStatusResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1ContractorsContractorUuidOnboardingStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1ContractorsContractorUuidOnboardingStatusResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1ContractorsContractorUuidOnboardingStatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1ContractorsContractorUuidOnboardingStatusResponse res = resBuilder.build();
