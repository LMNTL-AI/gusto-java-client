...
import com.gusto.embedded_api.models.operations.GetV1TimeOffRequestsTimeOffRequestUuidRequest;
...
public class GetV1TimeOffRequestsTimeOffRequestUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1TimeOffRequestsTimeOffRequestUuidRequest, com.gusto.embedded_api.models.operations.async.GetV1TimeOffRequestsTimeOffRequestUuidResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1TimeOffRequestsTimeOffRequestUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1TimeOffRequestsTimeOffRequestUuidResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1TimeOffRequestsTimeOffRequestUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1TimeOffRequestsTimeOffRequestUuidResponse res = resBuilder.build();
