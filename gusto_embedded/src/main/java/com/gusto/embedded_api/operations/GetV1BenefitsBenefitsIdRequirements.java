...
public class GetV1BenefitsBenefitsIdRequirements {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1BenefitsBenefitsIdRequirementsRequest, com.gusto.embedded_api.models.operations.async.GetV1BenefitsBenefitsIdRequirementsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1BenefitsBenefitsIdRequirementsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1BenefitsBenefitsIdRequirementsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1BenefitsBenefitsIdRequirementsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1BenefitsBenefitsIdRequirementsResponse res = resBuilder.build();
