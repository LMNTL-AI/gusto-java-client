...
import com.gusto.embedded_api.models.operations.GetV1EmployeesEmployeeIdRecurringReimbursementsRequest;
...
public class GetV1EmployeesEmployeeIdRecurringReimbursements {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1EmployeesEmployeeIdRecurringReimbursementsRequest, com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdRecurringReimbursementsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdRecurringReimbursementsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdRecurringReimbursementsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdRecurringReimbursementsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdRecurringReimbursementsResponse res = resBuilder.build();
