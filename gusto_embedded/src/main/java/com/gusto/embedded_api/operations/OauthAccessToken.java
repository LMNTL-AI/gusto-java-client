...
import com.gusto.embedded_api.models.operations.OauthAccessTokenResponse;
...
public class OauthAccessToken {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<OauthAccessTokenRequest, com.gusto.embedded_api.models.operations.async.OauthAccessTokenResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.OauthAccessTokenResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.OauthAccessTokenResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.OauthAccessTokenResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
