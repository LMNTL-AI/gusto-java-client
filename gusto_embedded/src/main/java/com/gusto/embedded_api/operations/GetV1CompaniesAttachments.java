...
public class GetV1CompaniesAttachments {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesAttachmentsRequest, com.gusto.embedded_api.models.operations.async.GetV1CompaniesAttachmentsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompaniesAttachmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompaniesAttachmentsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompaniesAttachmentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompaniesAttachmentsResponse res = resBuilder.build();
