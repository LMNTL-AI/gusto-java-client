...
public class PutV1CompaniesCompanyUuidHolidayPayPolicyRemove {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesCompanyUuidHolidayPayPolicyRemoveRequest, com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyUuidHolidayPayPolicyRemoveResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyUuidHolidayPayPolicyRemoveResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyUuidHolidayPayPolicyRemoveResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyUuidHolidayPayPolicyRemoveResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyUuidHolidayPayPolicyRemoveResponse res = resBuilder.build();
