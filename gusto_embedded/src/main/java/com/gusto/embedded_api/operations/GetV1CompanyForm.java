...
public class GetV1CompanyForm {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompanyFormRequest, com.gusto.embedded_api.models.operations.async.GetV1CompanyFormResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompanyFormResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompanyFormResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompanyFormResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompanyFormResponse res = resBuilder.build();
