...
import com.gusto.embedded_api.models.components.SalaryEstimate;
...
public class PostV1SalaryEstimatesUuidAccept {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1SalaryEstimatesUuidAcceptRequest, com.gusto.embedded_api.models.operations.async.PostV1SalaryEstimatesUuidAcceptResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1SalaryEstimatesUuidAcceptResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1SalaryEstimatesUuidAcceptResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1SalaryEstimatesUuidAcceptResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1SalaryEstimatesUuidAcceptResponse res = resBuilder.build();
