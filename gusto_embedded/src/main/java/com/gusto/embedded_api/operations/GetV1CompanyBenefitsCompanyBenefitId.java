...
public class GetV1CompanyBenefitsCompanyBenefitId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompanyBenefitsCompanyBenefitIdRequest, com.gusto.embedded_api.models.operations.async.GetV1CompanyBenefitsCompanyBenefitIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompanyBenefitsCompanyBenefitIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompanyBenefitsCompanyBenefitIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompanyBenefitsCompanyBenefitIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompanyBenefitsCompanyBenefitIdResponse res = resBuilder.build();
