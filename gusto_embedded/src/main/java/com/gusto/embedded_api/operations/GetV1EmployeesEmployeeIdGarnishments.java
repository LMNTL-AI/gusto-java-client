...
public class GetV1EmployeesEmployeeIdGarnishments {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1EmployeesEmployeeIdGarnishmentsRequest, com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdGarnishmentsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdGarnishmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdGarnishmentsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdGarnishmentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1EmployeesEmployeeIdGarnishmentsResponse res = resBuilder.build();
