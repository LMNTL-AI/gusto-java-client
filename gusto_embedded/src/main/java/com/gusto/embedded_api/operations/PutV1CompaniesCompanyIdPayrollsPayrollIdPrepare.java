...
public class PutV1CompaniesCompanyIdPayrollsPayrollIdPrepare {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareRequest, com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareResponse res = resBuilder.build();
