...
public class GetV1HomeAddressesHomeAddressUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1HomeAddressesHomeAddressUuidRequest, com.gusto.embedded_api.models.operations.async.GetV1HomeAddressesHomeAddressUuidResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1HomeAddressesHomeAddressUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1HomeAddressesHomeAddressUuidResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1HomeAddressesHomeAddressUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1HomeAddressesHomeAddressUuidResponse res = resBuilder.build();
