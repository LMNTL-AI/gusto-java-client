...
public class GetV1ContractorPaymentGroupsIdPartnerDisbursements {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ContractorPaymentGroupsIdPartnerDisbursementsRequest, com.gusto.embedded_api.models.operations.async.GetV1ContractorPaymentGroupsIdPartnerDisbursementsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1ContractorPaymentGroupsIdPartnerDisbursementsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1ContractorPaymentGroupsIdPartnerDisbursementsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1ContractorPaymentGroupsIdPartnerDisbursementsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1ContractorPaymentGroupsIdPartnerDisbursementsResponse res = resBuilder.build();
