...
public class GetV1CompaniesCompanyUuidSignatories {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyUuidSignatoriesRequest, com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyUuidSignatoriesResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyUuidSignatoriesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyUuidSignatoriesResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyUuidSignatoriesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyUuidSignatoriesResponse res = resBuilder.build();
