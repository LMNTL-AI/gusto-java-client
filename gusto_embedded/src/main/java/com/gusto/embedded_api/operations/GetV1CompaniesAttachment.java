...
public class GetV1CompaniesAttachment {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesAttachmentRequest, com.gusto.embedded_api.models.operations.async.GetV1CompaniesAttachmentResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompaniesAttachmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompaniesAttachmentResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompaniesAttachmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompaniesAttachmentResponse res = resBuilder.build();
