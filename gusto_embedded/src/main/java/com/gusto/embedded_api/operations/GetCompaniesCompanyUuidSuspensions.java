...
public class GetCompaniesCompanyUuidSuspensions {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCompaniesCompanyUuidSuspensionsRequest, com.gusto.embedded_api.models.operations.async.GetCompaniesCompanyUuidSuspensionsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetCompaniesCompanyUuidSuspensionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetCompaniesCompanyUuidSuspensionsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetCompaniesCompanyUuidSuspensionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetCompaniesCompanyUuidSuspensionsResponse res = resBuilder.build();
