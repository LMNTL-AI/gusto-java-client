...
import com.gusto.embedded_api.models.components.PartnerManagedCompanyMigrateResponse;
...
public class PutV1PartnerManagedCompaniesCompanyUuidMigrate {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1PartnerManagedCompaniesCompanyUuidMigrateRequest, com.gusto.embedded_api.models.operations.async.PutV1PartnerManagedCompaniesCompanyUuidMigrateResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1PartnerManagedCompaniesCompanyUuidMigrateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1PartnerManagedCompaniesCompanyUuidMigrateResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1PartnerManagedCompaniesCompanyUuidMigrateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1PartnerManagedCompaniesCompanyUuidMigrateResponse res = resBuilder.build();
