...
public class PutV1WorkAddressesWorkAddressUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1WorkAddressesWorkAddressUuidRequest, com.gusto.embedded_api.models.operations.async.PutV1WorkAddressesWorkAddressUuidResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1WorkAddressesWorkAddressUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1WorkAddressesWorkAddressUuidResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1WorkAddressesWorkAddressUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1WorkAddressesWorkAddressUuidResponse res = resBuilder.build();
