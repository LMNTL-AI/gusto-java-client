...
public class GetV1CompaniesCompanyIdUnprocessedTerminationPayPeriods {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyIdUnprocessedTerminationPayPeriodsRequest, com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdUnprocessedTerminationPayPeriodsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdUnprocessedTerminationPayPeriodsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdUnprocessedTerminationPayPeriodsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdUnprocessedTerminationPayPeriodsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
