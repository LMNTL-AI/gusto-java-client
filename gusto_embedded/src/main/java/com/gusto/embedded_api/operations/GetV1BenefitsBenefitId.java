...
public class GetV1BenefitsBenefitId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1BenefitsBenefitIdRequest, com.gusto.embedded_api.models.operations.async.GetV1BenefitsBenefitIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1BenefitsBenefitIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1BenefitsBenefitIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1BenefitsBenefitIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1BenefitsBenefitIdResponse res = resBuilder.build();
