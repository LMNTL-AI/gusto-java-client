...
import com.gusto.embedded_api.models.components.PayrollShow;
...
public class GetV1CompaniesCompanyIdPayrollsPayrollId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyIdPayrollsPayrollIdRequest, com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdPayrollsPayrollIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdPayrollsPayrollIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdPayrollsPayrollIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdPayrollsPayrollIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdPayrollsPayrollIdResponse res = resBuilder.build();
