...
public class GetV1GeneratedDocumentsDocumentTypeRequestUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1GeneratedDocumentsDocumentTypeRequestUuidRequest, com.gusto.embedded_api.models.operations.async.GetV1GeneratedDocumentsDocumentTypeRequestUuidResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1GeneratedDocumentsDocumentTypeRequestUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1GeneratedDocumentsDocumentTypeRequestUuidResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1GeneratedDocumentsDocumentTypeRequestUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1GeneratedDocumentsDocumentTypeRequestUuidResponse res = resBuilder.build();
