...
public class PutV1ContractorsContractorUuidAddress {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1ContractorsContractorUuidAddressRequest, com.gusto.embedded_api.models.operations.async.PutV1ContractorsContractorUuidAddressResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1ContractorsContractorUuidAddressResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1ContractorsContractorUuidAddressResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1ContractorsContractorUuidAddressResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1ContractorsContractorUuidAddressResponse res = resBuilder.build();
