...
public class PutV1CompaniesCompanyUuidHolidayPayPolicyAdd {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesCompanyUuidHolidayPayPolicyAddRequest, com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyUuidHolidayPayPolicyAddResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyUuidHolidayPayPolicyAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyUuidHolidayPayPolicyAddResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyUuidHolidayPayPolicyAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1CompaniesCompanyUuidHolidayPayPolicyAddResponse res = resBuilder.build();
