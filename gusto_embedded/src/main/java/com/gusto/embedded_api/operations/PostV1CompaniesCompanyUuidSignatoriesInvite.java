...
public class PostV1CompaniesCompanyUuidSignatoriesInvite {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompaniesCompanyUuidSignatoriesInviteRequest, com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyUuidSignatoriesInviteResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyUuidSignatoriesInviteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyUuidSignatoriesInviteResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyUuidSignatoriesInviteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyUuidSignatoriesInviteResponse res = resBuilder.build();
