...
import com.gusto.embedded_api.models.components.ContractorPaymentGroupWithBlockers;
...
public class GetV1CompaniesCompanyIdContractorPaymentGroups {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyIdContractorPaymentGroupsRequest, com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdContractorPaymentGroupsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdContractorPaymentGroupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdContractorPaymentGroupsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdContractorPaymentGroupsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdContractorPaymentGroupsResponse res = resBuilder.build();
